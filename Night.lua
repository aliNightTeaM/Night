...
DevId = Config.DevId
SudoIds = {Config.SudoIds,782717203,1809393499,1779659067,1746615144,1619263064}
Night = Config.Night
...
local Status = AliNight:sismember(Night..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:AdminAll:',msg.sender_user_id_) 
...
var = true  
elseif AliNight:sismember(Night..'Abs:ManagerAll:', user_id) then
var = true  
elseif AliNight:sismember(Night..'Abs:AdminAll:', user_id) then
var = true  
elseif AliNight:sismember(Night..'Abs:VipAll:', user_id) then
var = true  
...
if AliNight:sismember(Night.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = AliNight:get(Night.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
if mrabs == "مميز" and VipMem(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Night')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
AliNight:set(Night.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
if mrabs == "مميز" and VipMem(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Night')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="⌁ المطور .",url="t.me/"..(dp.username_ or "Night")}}}
...
Ali_Night(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "Night")..')', 1, 'md') 
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Night,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
...
--     Source Night     --
if text == "الرابط" then
if not AliNight:get(Night.."Abs:Lock:GpLinks"..msg.chat_id_) then 
if AliNight:get(Night.."Abs:Groups:Links"..msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, "⌁︙𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"..AliNight:get(Night.."Abs:Groups:Links"..msg.chat_id_), 1, "html")
else 
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙لايوجد رابط ارسل ↫ ضع رابط او ارسل ↫ انشاء رابط للانشاء', 1, 'md')
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙جلب رابط المجموعه معطل', 1, 'md')
end
end
--     Source Night     --
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then AliNight:del(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع رسائلك', 1, 'md') end
...
if not AliNight:get(Night..'Abs:Lock:Games'..msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1,[[
...
if AliNight:get(Night.."Abs:Left:Bot"..Night) and not SecondSudo(msg) then
Ali_Night(msg.chat_id_,msg.id_, 1, "⌁︙المغادره معطله من قبل المطور الاساسي", 1, 'md')
return false  
end
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم مغادرة المجموعه \n⌁︙تم حذف جميع بياناتها ', 1, 'md')
ChatLeave(msg.chat_id_, Night)
AliNight:srem(Night.."Abs:Groups",msg.chat_id_)
end
--     Source Night     --
...
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws Night](t.me/sheserlo0SEND_BOT)
]]
...
--     Source Night     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙@HMSEBOT', 1, 'md') end
...
if text == "ايديي" and ChCheck(msg) then Ali_Night(msg.chat_id_, msg.id_, 1,'⌁︙ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then AliNight:del(Night..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
...
if AliNight:sismember(Night..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if AliNight:sismember(Night..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if AliNight:sismember(Night..'Abs:VipAll:',result.sender_user_id_) then
...
sudobot = 'المطورين • ' else sudobot = '' end
if AliNight:sismember(Night..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if AliNight:sismember(Night..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if AliNight:sismember(Night..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
AliNight:srem(Night..'Abs:ManagerAll:', result.id_)
AliNight:srem(Night..'Abs:AdminAll:', result.id_)
AliNight:srem(Night..'Abs:VipAll:', result.id_)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:ManagerAll:',result.id_)
...
AliNight:sadd(Night..'Abs:ManagerAll:',user)
...
AliNight:srem(Night..'Abs:ManagerAll:',user)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:AdminAll:',result.id_)
...
AliNight:sadd(Night..'Abs:AdminAll:',user)
...
AliNight:srem(Night..'Abs:AdminAll:',user)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:VipAll:',result.id_)
...
AliNight:sadd(Night..'Abs:VipAll:',user)
...
AliNight:srem(Night..'Abs:VipAll:',user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and AliNight:get(Night.."Abs:Lock:ProSet"..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'⌁︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع من قبل المنشئيين', 1, 'md')
return false
end
AliNight:sadd(Night..'Abs:Admins:'..msg.chat_id_,result.sender_user_id_)
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف الرساله مع رسالة الامر', 1, 'md')
end end end
--     Source Night     --
if Constructor(msg) then
...
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم تفعيل رفع ↫ الادمن • المميز', 1, 'md')
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم تعطيل رفع ↫ الادمن • المميز', 1, 'md')
end
end
--     Source Night     --
--          Kick          --
...
if not Constructor(msg) and AliNight:get(Night.."Abs:Lock:MuteTked"..msg.chat_id_) then 
...
if AliNight:get(Night..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then AliNight:sadd(Night.."Abs:cleaner"..msg.chat_id_, msg.id_) else AliNight:sadd(Night.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
...
local List = AliNight:smembers(Night..'Abs:ManagerAll:')
...
local List = AliNight:smembers(Night..'Abs:VipAll:')
...
if Number > 1000 then 
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙لاتستطيع تنظيف اكثر من 1000 رساله', 1, 'md')
return false  
end  
...
AliNight:del(Night..'Abs:AdminAll:')
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and AliNight:get(Night..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and AliNight:get(Night..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and AliNight:get(Night..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and AliNight:get(Night..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "Night")..")"
else 
...
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙تم التحديث الى الاصدار 2.0', 1, 'md') 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@sheserlo0]', 1, 'md')    
end 
--     Source Night     --
if Sudo(msg) then 
...
if AliNight:get(Night..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
