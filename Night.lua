...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/Night' end
...
os.execute('wget https://raw.githubusercontent.com/NightTEM/Night/master/Night.lua') 
dofile('Night.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/NightTEM/NightFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/NightTEM/NightFiles/master/NightFiles/"..FileName)
if Res == 200 then
